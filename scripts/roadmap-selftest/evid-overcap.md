# fixture — a roadmap ROW carrying more receipts than the cap, while no ONE of its names does
...
- **`a-falsity`** — FALSITY, `PROBED×7`: worst class goes first.
...
- **`fam-{alpha,beta}`** — DIFFICULTY, `PROBED×8`: brace expansion counts as
  naming both.
