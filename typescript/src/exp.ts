...
// JSON for the Agda decoder, and interpreted twice on this side (the
// mirror evaluator, and a compiler onto the real-rxjs primitives).
//
...
// (Agda's wkᵍ has no twin: with de Bruijn indices, weakening is the
// index shift performed inside unfoldMu.)
