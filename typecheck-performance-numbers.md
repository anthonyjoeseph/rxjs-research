...
| `make gate-heavy (full gate, 7 modules)` | **13.0 s** | 40.0 s | 7 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 580 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 194 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 29.8 s | 36 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **3.1 s** | >45 s | 50 |
