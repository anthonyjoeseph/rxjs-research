...
| `make agda (full gate, 19 modules)` | **31.0 s** | 1160.0 s | 8 |
...
| `agda-dev Verify-Budget-Sufficient/Measures.agda` | **15.2 s** | 15.2 s | 6 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **8.1 s** | 8.1 s | 3 |
...
| `agda-dev Verify-Well-Formed/Part10.agda` | **7.7 s** | 7.7 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level.agda` | **5.5 s** | 28.7 s | 16 |
