...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **102.1 s** | 138.8 s | 9 |
...
| `agda-dev Verify-Budget-Sufficient/Caps.agda` | **46.5 s** | 47.9 s | 3 |
...
| `agda-dev ../evidence/probed/Probed/Main.agda` | **14.1 s** | 14.1 s | 7 |
| `agda-dev Verify-Budget-Sufficient/Hop-Spine-Sub.agda` | **13.8 s** | 13.8 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 40.7 s | 35 |
| `agda-dev ../evidence/probed/Probed/Thru-Step-Indexed.agda` | **13.3 s** | 13.3 s | 1 |
| `agda-dev CLI/Decode.agda` | **13.3 s** | 13.3 s | 1 |
| `agda-dev ../evidence/probed/Probed/Cross-Count-Store.agda` | **13.1 s** | 16.4 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Live-Nest-Walk.agda` | **11.9 s** | 13.4 s | 11 |
...
| `agda-dev ../evidence/refuted/Refuted/Drain-Queue-Slot.agda` | **10.9 s** | 10.9 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Nest-Store.agda` | **10.9 s** | 10.9 s | 4 |
...
| `agda-dev Verify-Budget-Sufficient/Nodes-Nest-Walk.agda` | **10.5 s** | 10.5 s | 7 |
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **10.4 s** | 13.5 s | 21 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Chain-Caps-OK.agda` | **10.1 s** | 10.1 s | 9 |
...
| `agda-dev ../evidence/probed/Probed/Cross-Count-Burst.agda` | **9.8 s** | 9.8 s | 2 |
| `agda-dev ../evidence/probed/Probed/Drain-Count-Slot.agda` | **9.8 s** | 9.8 s | 1 |
...
| `agda-dev ../evidence/probed/Probed/Cross-Count-Slot.agda` | **9.7 s** | 9.7 s | 2 |
| `agda-dev ../evidence/refuted/Refuted/Size-Climb-Afford.agda` | **9.7 s** | 9.7 s | 2 |
| `agda-dev ../evidence/probed/Probed/Drain-Count-Join.agda` | **9.6 s** | 9.6 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Nest.agda` | **9.6 s** | 9.6 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Walk-Factor.agda` | **9.6 s** | 21.4 s | 2 |
...
| `agda-dev Rx/Layer-Count.agda` | **5.6 s** | 6.6 s | 3 |
