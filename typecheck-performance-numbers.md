...
| `agda-dev Rx/Evaluator/Builder.agda` | **14.6 s** | 16.8 s | 3 |
...
| `agda-dev Rx/Obs-Depth/Substitution.agda` | **7.1 s** | 11.2 s | 2 |
...
| `agda-dev Rx/Evaluator/Doorless.agda` | **6.5 s** | 6.5 s | 4 |
| `agda-dev CLI/IO.agda` | **6.4 s** | 6.4 s | 1 |
| `agda-dev ../evidence/probed/Probed/Template-Depth.agda` | **6.3 s** | 6.3 s | 1 |
