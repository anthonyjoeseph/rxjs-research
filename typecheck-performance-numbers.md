...
| `make agda (full gate, 11 modules)` | **1030.0 s** | 1030.0 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Tower.agda` | **3.6 s** | 5.5 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Depth-Compositional.agda` | **3.4 s** | 4.4 s | 5 |
