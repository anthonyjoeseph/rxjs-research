...
| `make gate-heavy (full gate, 18 modules)` | **28.0 s** | 1469.0 s | 7 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 926 |
