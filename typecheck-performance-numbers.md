...
| `make agda (full gate, 11 modules)` | **1046.0 s** | 1046.0 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Tower.agda` | **3.6 s** | 4.5 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Depth-Compositional.agda` | **3.4 s** | 3.6 s | 4 |
