...
| `make gate-heavy (full gate, 6 modules)` | **10.0 s** | 27.0 s | 7 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 780 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 12.1 s | 75 |
