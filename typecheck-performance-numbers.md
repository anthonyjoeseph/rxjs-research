...
| `agda-dev Verify-Budget-Sufficient/Subscribe-Face.agda` | **13.8 s** | 18.1 s | 8 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 614 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 211 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | >45 s | 40 |
