...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Connect.agda` | **25.9 s** | 26.0 s | 14 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **8.7 s** | 16.2 s | 18 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 231 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 81 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part3.agda` | **6.2 s** | 12.1 s | 2 |
| `make gate-heavy (full gate, 1 modules)` | **6.0 s** | 6.0 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Arms.agda` | **5.6 s** | 6.6 s | 18 |
...
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | >1 s | 38 |
