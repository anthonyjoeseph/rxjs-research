...
| `make gate-heavy (full gate, 13 modules)` | **91.0 s** | 91.0 s | 3 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 966 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 278 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part6.agda` | **6.4 s** | 11.3 s | 6 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Nest-Arith.agda` | **5.6 s** | 5.6 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 29.2 s | 101 |
| `agda-dev ../evidence/refuted/Refuted/Chain-Level-Unbounded.agda` | **5.3 s** | 5.3 s | 1 |
| `agda-dev QuickCheck.agda` | **5.3 s** | 5.3 s | 2 |
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | >1 s | 154 |
...
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **3.8 s** | 3.8 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Depth-Sighted.agda` | **3.7 s** | 57.8 s | 10 |
...
| `agda-dev Verify-Budget-Sufficient/Sighted-Fit.agda` | **3.7 s** | 4.3 s | 2 |
...
| `agda-dev ../evidence/refuted/Refuted/Thru-Subscribe-Nest.agda` | **3.4 s** | 3.4 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **3.1 s** | 45.7 s | 77 |
