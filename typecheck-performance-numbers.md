...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Arrival-Caps.agda` | **14.4 s** | 14.5 s | 4 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 23.4 s | 14 |
