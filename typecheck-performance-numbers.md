...
| `agda-dev ../evidence/probed/Probed/Fit-Preserved.agda` | **12.1 s** | 12.1 s | 2 |
...
| `agda-dev Verify-Rank-Sufficient/Hop.agda` | **7.5 s** | 7.5 s | 2 |
| `agda-dev Verify-Support/Node-Fresh.agda` | **7.5 s** | 7.5 s | 1 |
| `agda-dev Verify-Support/Node-Table.agda` | **7.5 s** | 7.5 s | 1 |
| `agda-dev Verify-Rank-Sufficient/Arrival-Fit.agda` | **7.4 s** | 7.4 s | 1 |
