...
| `agda-dev Verify-Budget-Sufficient/Caps.agda` | **14.1 s** | 21.1 s | 8 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 948 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 28.9 s | 97 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part1.agda` | **3.9 s** | 14.6 s | 11 |
