...
| `agda-dev ../evidence/probed/Probed/Fit-Preserved.agda` | — | >160 s | 1 |
...
| `agda-dev Verify-Rank-Sufficient/Hop.agda` | **7.9 s** | 7.9 s | 1 |
...
| `agda-dev Verify-Rank-Sufficient.agda` | **7.7 s** | 7.7 s | 1 |
