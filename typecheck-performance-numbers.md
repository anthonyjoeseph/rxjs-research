...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **47.4 s** | >160 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Arrival-Caps.agda` | **14.4 s** | 15.6 s | 12 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Strat-Leaves.agda` | **8.9 s** | 8.9 s | 2 |
