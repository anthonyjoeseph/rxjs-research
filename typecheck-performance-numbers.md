...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Walk-Sink.agda` | **24.2 s** | 37.3 s | 12 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 31.0 s | 48 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Nest-Arith.agda` | **11.5 s** | 19.4 s | 14 |
...
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **10.4 s** | >160 s | 37 |
...
| `agda-dev Verify-Budget-Sufficient/Nodes-Nest-Walk.agda` | **10.1 s** | 18.3 s | 9 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Strat-Leaves.agda` | **8.6 s** | 14.3 s | 9 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Factor.agda` | **8.0 s** | 12.6 s | 4 |
