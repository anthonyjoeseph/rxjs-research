...
| `agda-dev Verify-Budget-Sufficient/Burst-Walk.agda` | **9.2 s** | 31.1 s | 16 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 820 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 269 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part6.agda` | **6.4 s** | 9.6 s | 5 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | >45 s | 83 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part5.agda` | **4.0 s** | 4.8 s | 8 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **3.1 s** | >45 s | 68 |
