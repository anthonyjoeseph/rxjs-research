...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 24.2 s | 47 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Nest-Arith.agda` | **11.5 s** | 13.5 s | 13 |
