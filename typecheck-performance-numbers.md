...
| `agda-dev Verify-Budget-Sufficient/Caps.agda` | **14.1 s** | 17.4 s | 5 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 725 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 238 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | >45 s | 62 |
| `agda-dev ../evidence/refuted/Refuted/Chain-Level-Unbounded.agda` | **5.3 s** | 5.3 s | 1 |
| `agda-dev QuickCheck.agda` | **5.3 s** | 5.3 s | 2 |
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | >1 s | 140 |
