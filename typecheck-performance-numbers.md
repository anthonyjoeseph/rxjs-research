...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **106.8 s** | 128.6 s | 6 |
...
| `agda-dev Verify-Budget-Sufficient/Burst-Room.agda` | **11.3 s** | 11.3 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Fold-Room.agda` | **9.5 s** | 9.5 s | 1 |
