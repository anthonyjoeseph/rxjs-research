...
| `make gate-heavy (full gate, 13 modules)` | **1106.0 s** | 1106.0 s | 2 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 942 |
