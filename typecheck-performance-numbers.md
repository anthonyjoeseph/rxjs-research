...
| `agda-dev Verify-Budget-Sufficient/Measures.agda` | **31.4 s** | 31.4 s | 4 |
...
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **10.4 s** | 20.3 s | 32 |
