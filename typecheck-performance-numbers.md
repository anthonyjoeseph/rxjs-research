...
| `make gate-heavy (full gate, 10 modules)` | **1011.0 s** | 1481.0 s | 3 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >45 s | 135 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >45 s | 53 |
...
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | >45 s | 25 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Store.agda` | **3.2 s** | 3.9 s | 5 |
