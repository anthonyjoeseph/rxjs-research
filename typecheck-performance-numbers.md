...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Connect.agda` | **25.9 s** | 26.8 s | 12 |
...
| `agda-dev Verify-Budget-Sufficient/Subscribe-Face.agda` | **13.8 s** | 31.1 s | 4 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **8.7 s** | 16.6 s | 16 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 205 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 75 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part3.agda` | **6.2 s** | 12.1 s | 2 |
| `make gate-heavy (full gate, 1 modules)` | **6.0 s** | 6.0 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Arms.agda` | **5.6 s** | 6.8 s | 16 |
...
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | >1 s | 34 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Subst.agda` | **4.1 s** | 4.1 s | 2 |
...
| `agda-dev ../evidence/refuted/Refuted/Inner-Drain-Nest.agda` | **3.3 s** | 3.3 s | 1 |
