...
| `agda-dev Main.agda` | **8.7 s** | 8.7 s | 5 |
...
| `agda-dev Verify-Well-Formed.agda` | **8.3 s** | 8.3 s | 1 |
| `agda-dev Verify-Rank-Sufficient/Path-Fits.agda` | **8.2 s** | 18.0 s | 4 |
| `agda-dev Rx/Rd-Slot-Cong.agda` | **8.1 s** | 9.4 s | 2 |
...
| `agda-dev Rx/Obs-Depth.agda` | **7.8 s** | 7.8 s | 1 |
...
| `agda-dev Verify-Rank-Sufficient/Hop-Edge.agda` | **7.4 s** | 7.4 s | 1 |
