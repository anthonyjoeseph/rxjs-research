...
| `agda-dev Rx/Subst-Elim-Weak.agda` | **7.6 s** | 7.6 s | 5 |
...
| `agda-dev ../evidence/probed/Probed/Take-Bounds.agda` | **6.8 s** | 6.8 s | 1 |
...
| `agda-dev Rx/Evaluator/Reducible.agda` | **6.2 s** | >2 s | 50 |
...
| `agda-dev Rx/Subst-Identity.agda` | **5.9 s** | 5.9 s | 4 |
| `agda-dev Rx/Subst-Transport.agda` | **5.8 s** | 5.8 s | 2 |
