...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 49.1 s | 32 |
...
| `agda-dev ../evidence/probed/Probed/Cross-Count-Spine.agda` | **11.4 s** | 11.4 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **10.4 s** | 18.5 s | 18 |
