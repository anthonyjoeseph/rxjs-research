...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >45 s | 421 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >45 s | 165 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 7.8 s | 22 |
| `agda-dev QuickCheck.agda` | **5.3 s** | 5.3 s | 2 |
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | >45 s | 109 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **3.1 s** | 8.2 s | 18 |
