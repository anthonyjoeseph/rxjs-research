...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 448 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 7.9 s | 24 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **3.1 s** | 13.0 s | 20 |
| `agda-dev Verify-Well-Formed/Part2.agda` | **3.1 s** | 3.1 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Nest-Cap.agda` | **3.0 s** | 3.0 s | 1 |
