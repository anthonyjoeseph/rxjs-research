...
| `agda-dev Rx/Evaluator/Freshness/Preserve.agda` | **16.0 s** | 16.0 s | 1 |
| `agda-dev Rx/Evaluator/Freshness/Mono.agda` | **15.8 s** | 15.8 s | 1 |
| `agda-dev Rx/Evaluator/Builder.agda` | **13.2 s** | 16.3 s | 8 |
| `agda-dev QuickCheck.agda` | **10.6 s** | 16.3 s | 4 |
| `agda-dev Rx/Evaluator/Keeps-Slots.agda` | **9.5 s** | 9.5 s | 2 |
...
| `agda-dev Rx/Subst-Ren-Fuse.agda` | **8.0 s** | 8.0 s | 2 |
| `agda-dev ../evidence/probed/Probed/Pipeline-Claims.agda` | **7.8 s** | 7.8 s | 2 |
| `agda-dev Rx/Subst-Elim-Weak.agda` | **7.8 s** | 7.8 s | 3 |
| `agda-dev Rx/Evaluator.agda` | **7.6 s** | 7.6 s | 9 |
| `agda-dev Rx/Evaluator/Domain.agda` | **7.5 s** | 10.8 s | 3 |
| `agda-dev Rx/Inputs-Below.agda` | **7.3 s** | 7.3 s | 2 |
...
| `agda-dev Rx/Subst-Transport.agda` | **7.1 s** | 7.1 s | 1 |
...
| `agda-dev ../evidence/probed/Probed/Seam.agda` | **6.8 s** | 6.8 s | 1 |
| `agda-dev Main.agda` | **6.8 s** | 6.8 s | 7 |
| `agda-dev Rx/Evaluator/Freshness.agda` | **6.7 s** | 6.7 s | 1 |
| `agda-dev Rx/Slots.agda` | **6.7 s** | 8.0 s | 2 |
| `agda-dev Verify-Take-Bounds.agda` | **6.7 s** | 9.5 s | 4 |
| `agda-dev Verify-Well-Formed.agda` | **6.7 s** | >1 s | 9 |
| `agda-dev ../evidence/probed/Probed/Take-Bounds.agda` | **6.6 s** | 7.6 s | 3 |
| `agda-dev Implementation/Unit-Test.agda` | **6.6 s** | 6.6 s | 2 |
| `agda-dev Verify-Adequacy.agda` | **6.6 s** | 6.6 s | 1 |
| `agda-dev Rx/Subst-Elim.agda` | **6.5 s** | 9.2 s | 2 |
| `agda-dev Rx/Subst-Renaming.agda` | **6.5 s** | 6.5 s | 2 |
| `agda-dev Verify-Determinacy.agda` | **6.5 s** | 6.5 s | 1 |
| `agda-dev CLI/IO.agda` | **6.4 s** | 6.4 s | 1 |
| `agda-dev CLI/Encode.agda` | **6.2 s** | 6.2 s | 3 |
| `agda-dev Rx/Evaluator/Reducible.agda` | **6.2 s** | >2 s | 46 |
| `agda-dev Rx/Subst-Split.agda` | **6.1 s** | 6.1 s | 2 |
| `agda-dev Rx/Subst-Eval.agda` | **6.0 s** | 12.3 s | 5 |
| `agda-dev Rx/Subst-Identity.agda` | **6.0 s** | 6.0 s | 3 |
| `agda-dev ../evidence/refuted/Refuted/Main.agda` | **5.9 s** | 5.9 s | 7 |
| `agda-dev Verify-Well-Formed/Invariant.agda` | **5.9 s** | 5.9 s | 1 |
