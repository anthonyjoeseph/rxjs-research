...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part4.agda` | **22.1 s** | 66.8 s | 5 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part1.agda` | **11.0 s** | 15.7 s | 3 |
