...
| `agda-dev QuickCheck.agda` | **10.6 s** | 21.5 s | 5 |
...
| `agda-dev Rx/Subst-Ren-Fuse.agda` | **7.8 s** | 7.8 s | 3 |
| `agda-dev Rx/Evaluator/Domain.agda` | **7.5 s** | 8.3 s | 4 |
| `agda-dev Rx/Subst-Elim-Weak.agda` | **7.5 s** | 7.5 s | 6 |
| `agda-dev ../evidence/probed/Probed/Main.agda` | **7.2 s** | 7.2 s | 10 |
| `agda-dev Rx/Time-Theorems.agda` | **7.2 s** | 7.2 s | 1 |
| `agda-dev Rx/Inputs-Below.agda` | **7.1 s** | 7.1 s | 3 |
| `agda-dev Rx/Evaluator-Theorems.agda` | **7.0 s** | 8.0 s | 4 |
| `agda-dev Rx/Exp.agda` | **7.0 s** | 13.1 s | 4 |
...
| `agda-dev Rx/Subst-Elim.agda` | **6.5 s** | 9.2 s | 2 |
| `agda-dev Verify-Determinacy.agda` | **6.5 s** | 6.5 s | 1 |
| `agda-dev CLI/IO.agda` | **6.4 s** | 6.4 s | 1 |
| `agda-dev Rx/Subst-Renaming.agda` | **6.4 s** | 6.4 s | 3 |
| `agda-dev Verify-Well-Formed.agda` | **6.4 s** | >1 s | 13 |
| `agda-dev Rx/Evaluator.agda` | **6.3 s** | 6.3 s | 11 |
...
| `agda-dev Rx/Exp/Guarded.agda` | **5.6 s** | 5.6 s | 1 |
| `agda-dev Rx/Subst-Compose.agda` | **5.6 s** | 6.6 s | 3 |
| `agda-dev Rx/Subst-Transport.agda` | **5.6 s** | 5.6 s | 3 |
| `agda-dev Rx/Subst-Identity.agda` | **5.5 s** | 5.5 s | 5 |
