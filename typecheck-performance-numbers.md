...
| `agda-dev Verify-Budget-Sufficient/Burst-Walk/Leaves.agda` | **19.7 s** | 19.7 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Burst-Room.agda` | **11.3 s** | 35.6 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Chain.agda` | **8.6 s** | 8.6 s | 2 |
...
| `agda-dev Rx/Layer-Count.agda` | **5.6 s** | 6.5 s | 5 |
