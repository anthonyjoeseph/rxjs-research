...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 76 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >1200 s | 35 |
...
| `agda-dev Verify-Well-Formed/Part3.agda` | **3.0 s** | 3.8 s | 6 |
| `agda-dev Verify-Budget-Sufficient/Depth-Compositional.agda` | **2.8 s** | 6.9 s | 8 |
| `agda-dev Rx/MergeAll-Laws.agda` | **2.7 s** | 3.3 s | 2 |
