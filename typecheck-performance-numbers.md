...
| `agda-dev Rx/Evaluator.agda` | **19.4 s** | 19.4 s | 5 |
...
| `agda-dev ../evidence/refuted/Refuted/Path-Heads.agda` | **8.4 s** | 8.4 s | 1 |
| `agda-dev Verify-Well-Formed/Part5.agda` | **8.4 s** | 8.4 s | 1 |
| `agda-dev CLI/Main.agda` | **8.3 s** | 8.3 s | 1 |
| `agda-dev Verify-Rank-Sufficient/Dry.agda` | **8.3 s** | 10.1 s | 3 |
...
| `agda-dev Verify-Well-Formed/Part2.agda` | **7.8 s** | 10.7 s | 3 |
