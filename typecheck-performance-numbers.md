...
| `make agda (full gate, 7 modules)` | **13.0 s** | 328.0 s | 3 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | 9.2 s | 4 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.7 s** | 5.7 s | 6 |
