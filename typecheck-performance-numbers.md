...
| `make gate-heavy (full gate, 15 modules)` | **19.0 s** | 1105.0 s | 4 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 989 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 280 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part6.agda` | **6.4 s** | 36.0 s | 7 |
| `agda-dev Verify-Budget-Sufficient/Nodes-Nest-Walk.agda` | **6.4 s** | 6.4 s | 1 |
...
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | >1 s | 156 |
...
| `agda-dev Verify-Budget-Sufficient/Live-Nest-Walk.agda` | **4.4 s** | 4.4 s | 1 |
| `agda-dev ../evidence/refuted/Refuted/Chain-Step-Store.agda` | **4.3 s** | 4.3 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Nest-Arith.agda` | **4.3 s** | 4.3 s | 4 |
