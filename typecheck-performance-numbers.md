...
| `agda-dev Rx/Evaluator/Freshness/Mono.agda` | **12.5 s** | 16.5 s | 4 |
...
| `agda-dev Rx/Evaluator/Reducible.agda` | **6.2 s** | >2 s | 53 |
...
| `agda-dev Rx/Evaluator/Freshness.agda` | **5.7 s** | 7.6 s | 4 |
...
| `agda-dev Rx/Elaborate.agda` | **5.4 s** | 9.0 s | 3 |
