...
| `agda-dev Implementation/Unit-Test.agda` | **6.6 s** | >2 s | 4 |
| `agda-dev Implementation/Unit-Test/Prelude.agda` | **6.6 s** | 6.6 s | 2 |
| `agda-dev CLI/IO.agda` | **6.4 s** | 6.4 s | 1 |
| `agda-dev Verify-Well-Formed.agda` | **6.4 s** | >1 s | 15 |
| `agda-dev Rx/Evaluator.agda` | **6.3 s** | 6.9 s | 13 |
| `agda-dev Rx/Evaluator/Reducible.agda` | **6.2 s** | >2 s | 55 |
