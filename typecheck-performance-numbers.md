...
| `agda-dev Implementation/Unit-Test/Bug-Cache.agda` | **8.0 s** | 8.0 s | 3 |
...
| `agda-dev CLI/Main.agda` | **6.8 s** | 6.8 s | 3 |
| `agda-dev Main.agda` | **6.8 s** | 6.8 s | 7 |
| `agda-dev Rx/Slots.agda` | **6.7 s** | 8.0 s | 2 |
| `agda-dev Implementation/Unit-Test.agda` | **6.6 s** | 7.4 s | 6 |
| `agda-dev Implementation/Unit-Test/Prelude.agda` | **6.6 s** | 6.7 s | 4 |
