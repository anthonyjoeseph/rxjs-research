...
| `agda-dev ../evidence/probed/Probed/Regs-Split-Budget.agda` | **600.4 s** | >120 s | 5 |
| `agda-dev Verify-Budget-Sufficient/Burst-Walk/Burst-Face.agda` | **600.3 s** | >600 s | 1 |
| `agda-dev ../evidence/probed/Probed/Tmp-Ctl.agda` | **300.4 s** | >300 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **102.1 s** | 152.7 s | 14 |
...
| `agda-dev Verify-Budget-Sufficient/Burst-Walk.agda` | **29.3 s** | >600 s | 9 |
