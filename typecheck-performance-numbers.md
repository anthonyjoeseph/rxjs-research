...
| `agda-dev Rx/Evaluator/Builder/Level.agda` | **6.8 s** | 6.8 s | 3 |
...
| `agda-dev Rx/Evaluator/Unconnected.agda` | **6.1 s** | 6.1 s | 1 |
...
| `agda-dev Rx/Evaluator/Builder.agda` | **5.6 s** | 5.6 s | 17 |
