...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **102.1 s** | 186.5 s | 24 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Arrival-Caps.agda` | **14.4 s** | 103.7 s | 14 |
