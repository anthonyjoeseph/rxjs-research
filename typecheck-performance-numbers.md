...
| `agda-dev Verify-Budget-Sufficient/Desc-Ceil.agda` | **18.2 s** | 18.2 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Burst.agda` | **11.4 s** | 11.4 s | 1 |
