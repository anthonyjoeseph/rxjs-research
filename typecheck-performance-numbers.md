...
| `agda-dev ../evidence/probed/Probed/Readme-Claims.agda` | **6.9 s** | 6.9 s | 2 |
| `agda-dev ../evidence/probed/Probed/Pipeline-Claims.agda` | **6.8 s** | 6.8 s | 3 |
