...
| `make gate-heavy (full gate, 50 modules)` | **660.0 s** | 1935.0 s | 2 |
...
| `agda-dev ../evidence/probed/Probed/Scan-Burst-Nest.agda` | **14.7 s** | 14.7 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Measures.agda` | **10.9 s** | 10.9 s | 8 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | 9.5 s | 298 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | 6.8 s | 104 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 8.0 s | 16 |
| `agda-dev QuickCheck.agda` | **5.3 s** | 5.3 s | 2 |
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | 5.4 s | 59 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **3.1 s** | 5.7 s | 10 |
