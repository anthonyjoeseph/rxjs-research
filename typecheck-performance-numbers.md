...
| `make gate-heavy (full gate, 5 modules)` | **9.0 s** | 16.0 s | 3 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 596 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 196 |
