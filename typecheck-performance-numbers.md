...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | 7.3 s | 3 |
...
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.4 s** | 5.4 s | 4 |
