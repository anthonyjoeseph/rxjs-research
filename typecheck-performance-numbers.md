...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **8.7 s** | 19.8 s | 6 |
...
| `agda-dev Verify-Budget-Sufficient/Psi-Split.agda` | **5.5 s** | 5.5 s | 2 |
