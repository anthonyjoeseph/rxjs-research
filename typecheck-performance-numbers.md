...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 40.3 s | 33 |
...
| `agda-dev ../evidence/probed/Probed/Cross-Count-Burst.agda` | **10.4 s** | 10.4 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **10.4 s** | 13.7 s | 19 |
...
| `agda-dev ../evidence/probed/Probed/Cross-Count-Slot.agda` | **10.2 s** | 10.2 s | 1 |
...
| `agda-dev ../evidence/refuted/Refuted/Walk-Ceil-Drain.agda` | **10.2 s** | 10.2 s | 1 |
...
| `agda-dev ../evidence/refuted/Refuted/Walk-Ceil-Ledger.agda` | **9.4 s** | 12.3 s | 3 |
