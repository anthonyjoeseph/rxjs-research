...
| `agda-dev Rx/Evaluator/Freshness/Preserve.agda` | **15.5 s** | 15.5 s | 3 |
| `agda-dev Rx/Evaluator/Freshness/Mono.agda` | **15.0 s** | 15.0 s | 3 |
...
| `agda-dev Rx/Evaluator.agda` | **6.1 s** | 6.7 s | 18 |
