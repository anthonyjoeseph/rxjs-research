...
| `agda-dev ../evidence/probed/Probed/Main.agda` | **114.4 s** | 130.4 s | 5 |
...
| `agda-dev ../evidence/refuted/Refuted/Main.agda` | **20.2 s** | 20.2 s | 3 |
...
| `agda-dev ../evidence/refuted/Refuted/Drain-Queue-Slot.agda` | **15.2 s** | 15.2 s | 1 |
