...
| `agda-dev Verify-Rank-Sufficient.agda` | **7.7 s** | 23.1 s | 3 |
| `agda-dev Verify-Rank-Sufficient/Dry-Emits.agda` | **7.7 s** | 7.7 s | 1 |
| `agda-dev Rx/Obs-Depth.agda` | **7.6 s** | 7.6 s | 2 |
