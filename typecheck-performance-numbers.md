...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Connect.agda` | **25.9 s** | >45 s | 21 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **8.7 s** | >45 s | 27 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 345 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 128 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part3.agda` | **6.0 s** | 6.0 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Arms.agda` | **5.6 s** | >45 s | 25 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 10.7 s | 19 |
| `agda-dev QuickCheck.agda` | **5.3 s** | 5.3 s | 2 |
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | >1 s | 74 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **3.1 s** | 6.6 s | 17 |
