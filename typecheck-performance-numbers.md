...
| `agda-dev Rx/Evaluator/Reducible.agda` | **6.2 s** | >2 s | 16 |
| `agda-dev ../evidence/probed/Probed/Reducible-Arms.agda` | **5.6 s** | 5.6 s | 2 |
