...
| `agda-dev Rx/Subst-Elim.agda` | **6.5 s** | 6.5 s | 1 |
| `agda-dev CLI/IO.agda` | **6.4 s** | 6.4 s | 1 |
| `agda-dev Rx/Evaluator/Reducible.agda` | **6.2 s** | >2 s | 39 |
