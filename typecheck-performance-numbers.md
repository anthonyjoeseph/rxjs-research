...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 880 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 392.9 s | 90 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part5.agda` | **4.0 s** | 17.8 s | 9 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Ceiling.agda` | **3.4 s** | 4.4 s | 2 |
