...
| `make gate-heavy (full gate, 11 modules)` | **20.0 s** | 20.0 s | 5 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 514 |
