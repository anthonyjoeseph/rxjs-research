...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 956 |
...
| `agda-dev ../evidence/probed/Probed/Chain-Step-Regs-Rootward.agda` | **4.0 s** | 4.0 s | 2 |
