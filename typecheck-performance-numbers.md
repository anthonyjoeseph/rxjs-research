...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Arrival-Caps.agda` | **14.4 s** | 24.9 s | 10 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 68.1 s | 41 |
...
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **10.4 s** | 26.1 s | 35 |
...
| `agda-dev Verify-Budget-Sufficient/Nodes-Nest-Walk.agda` | **10.1 s** | 10.1 s | 8 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Factor.agda` | **8.0 s** | 8.0 s | 3 |
