...
| `agda-dev Verify-Budget-Sufficient/Caps.agda` | **14.1 s** | 31.7 s | 7 |
| `make gate-heavy (full gate, 9 modules)` | **14.0 s** | 1033.0 s | 5 |
| `make gate-heavy (full gate, 7 modules)` | **13.0 s** | 63.0 s | 10 |
| `agda-dev Verify-Budget-Sufficient/Subscribe-Face.agda` | **12.2 s** | 12.2 s | 10 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part4.agda` | **7.7 s** | 19.6 s | 7 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 824 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 271 |
...
| `agda-dev Verify-Budget-Sufficient/Init-Caps.agda` | **3.5 s** | 4.1 s | 8 |
