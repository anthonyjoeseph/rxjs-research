...
| `agda-dev Rx/Evaluator/Builder/Level.agda` | **6.8 s** | 9.1 s | 4 |
...
| `agda-dev Rx/Evaluator/Builder/Frames.agda` | **6.3 s** | 8.0 s | 2 |
| `agda-dev Rx/Evaluator.agda` | **6.1 s** | 6.1 s | 14 |
| `agda-dev Rx/Evaluator/Unconnected.agda` | **6.1 s** | 8.3 s | 2 |
...
| `agda-dev Rx/Evaluator/Reducible.agda` | **5.8 s** | 6.7 s | 62 |
| `agda-dev Rx/SExp.agda` | **5.8 s** | 5.8 s | 2 |
| `agda-dev Rx/Envelope/Decode.agda` | **5.6 s** | 5.6 s | 1 |
| `agda-dev Rx/Evaluator/Builder.agda` | **5.6 s** | 7.4 s | 18 |
