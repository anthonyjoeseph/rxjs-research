...
| `agda-dev ../evidence/refuted/Refuted/Red-Step-Vacuous.agda` | **7.0 s** | 7.0 s | 1 |
...
| `agda-dev Rx/Evaluator/Reducible.agda` | **6.2 s** | >2 s | 28 |
...
| `agda-dev ../evidence/probed/Probed/Reducible-Arms.agda` | **5.6 s** | 6.5 s | 3 |
