...
| `agda-dev Verify-Input-Well-Formed/Run-Well-Formed.agda` | — | >45 s | 1 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **5.6 s** | >1 s | 1025 |
...
| `agda-dev Rx/Elaborate.agda` | **3.4 s** | 3.4 s | 1 |
| `agda-dev Implementation/Unit-Test/Prelude.agda` | **3.3 s** | >1 s | 2 |
| `agda-dev Rx/Exp.agda` | **3.2 s** | 3.2 s | 3 |
| `agda-dev Rx/SExp.agda` | **2.7 s** | 2.7 s | 1 |
| `agda-dev Rx/Slots.agda` | **2.5 s** | 2.5 s | 3 |
| `agda-dev Decide.agda` | **1.6 s** | 1.6 s | 1 |
| `agda-dev Verify-Input-Well-Formed/Well-Shaped.agda` | **1.6 s** | 1.6 s | 1 |
| `agda-dev Rx/Mint.agda` | **1.4 s** | 1.4 s | 1 |
| `agda-dev Implementation/Unit-Test.agda` | — | >1 s | 1 |
| `agda-dev Implementation/Unit-Test/Bug-Cache.agda` | — | >1 s | 1 |
| `agda-dev Spec.agda` | — | >1 s | 1 |
...
| `agda-dev QuickCheck.agda` | **10.6 s** | 32.8 s | 9 |
| `agda-dev Implementation/Unit-Test/Bug-Cache.agda` | **7.5 s** | >1 s | 8 |
| `agda-dev Rx/Evaluator/Domain.agda` | **7.5 s** | 54.3 s | 10 |
| `agda-dev Rx/Plain.agda` | **7.4 s** | >1 s | 3 |
| `agda-dev Verify-Input-Well-Formed/Run-Well-Formed.agda` | **7.3 s** | >1 s | 3 |
| `agda-dev ../evidence/probed/Probed/Main.agda` | **7.2 s** | 7.2 s | 10 |
| `agda-dev Rx/Inputs-Below.agda` | **7.1 s** | 7.5 s | 5 |
| `agda-dev CLI/Decode.agda` | **7.0 s** | >2 s | 9 |
...
| `agda-dev Implementation/Unit-Test.agda` | **6.6 s** | >1 s | 9 |
| `agda-dev Implementation/Unit-Test/Prelude.agda` | **6.6 s** | >1 s | 7 |
| `agda-dev Rx/Evaluator/Freshness.agda` | **6.5 s** | 6.5 s | 1 |
| `agda-dev CLI/IO.agda` | **6.4 s** | 6.4 s | 1 |
| `agda-dev Verify-Batch-Simultaneous/Well-Formed.agda` | **6.4 s** | >1 s | 2 |
| `agda-dev Rx/Evaluator/Unconn-Arith.agda` | **6.3 s** | 7.5 s | 2 |
| `agda-dev Rx/Evaluator.agda` | **6.1 s** | 23.4 s | 20 |
| `agda-dev Rx/Simul-Slots.agda` | **6.0 s** | >1 s | 2 |
