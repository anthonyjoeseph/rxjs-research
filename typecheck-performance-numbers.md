...
| `make agda (full gate, 17 modules)` | **24.0 s** | 24.0 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **10.2 s** | 10.2 s | 4 |
...
| `agda-dev Verify-Well-Formed/Part8.agda` | **9.1 s** | 12.9 s | 2 |
| `agda-dev Verify-Well-Formed/Part4.agda` | **9.0 s** | 9.0 s | 2 |
| `agda-dev Verify-Well-Formed/Part7.agda` | **8.8 s** | 8.8 s | 1 |
| `agda-dev Verify-Well-Formed/Part12.agda` | **8.7 s** | 8.7 s | 1 |
| `agda-dev Verify-Well-Formed/Part11.agda` | **8.4 s** | 8.4 s | 2 |
