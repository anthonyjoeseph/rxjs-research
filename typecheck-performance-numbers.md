...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Walk-Sink.agda` | **24.2 s** | 24.2 s | 11 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part1.agda` | **11.0 s** | 13.8 s | 6 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Strat-Leaves.agda` | **11.0 s** | 11.0 s | 1 |
