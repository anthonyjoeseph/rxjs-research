...
| `make gate-heavy (full gate, 25 modules)` | **1211.0 s** | 1211.0 s | 2 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 788 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 261 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 27.4 s | 77 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part1.agda` | **3.9 s** | 5.4 s | 9 |
