...
| `make gate-heavy (full gate, 8 modules)` | **41.0 s** | 41.0 s | 3 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 667 |
