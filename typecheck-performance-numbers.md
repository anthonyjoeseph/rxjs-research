...
| `agda-dev Rx/Evaluator/Reducible/Support.agda` | **37.5 s** | 37.5 s | 1 |
...
| `agda-dev ../evidence/probed/Probed/Rule-Kept.agda` | **12.6 s** | 12.6 s | 1 |
...
| `agda-dev Rx/Evaluator/Reducible.agda` | **5.6 s** | 57.7 s | 77 |
