...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 981 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | >45 s | 105 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Nest-Arith.agda` | **4.4 s** | 4.4 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **3.8 s** | 5.5 s | 6 |
