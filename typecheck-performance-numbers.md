...
| `agda-dev Rx/Evaluator/Builder.agda` | **13.8 s** | 18.5 s | 6 |
| `agda-dev CLI/Decode.agda` | **13.3 s** | 13.3 s | 1 |
| `agda-dev Rx/Evaluator.agda` | **10.9 s** | 10.9 s | 7 |
...
| `agda-dev ../evidence/refuted/Refuted/Scan-Reachable.agda` | **8.3 s** | 38.3 s | 3 |
| `agda-dev CLI/Main.agda` | **8.3 s** | 8.3 s | 1 |
| `agda-dev Rx/Evaluator/Burst-Report.agda` | **8.0 s** | 10.8 s | 6 |
| `agda-dev ../evidence/refuted/Refuted/Template-Passes.agda` | **7.9 s** | 7.9 s | 1 |
| `agda-dev Rx/Evaluator/Reducible.agda` | **7.9 s** | 10.5 s | 3 |
| `agda-dev Rx/Sync-Size.agda` | **7.9 s** | 7.9 s | 1 |
| `agda-dev Verify-Well-Formed.agda` | **7.9 s** | >1 s | 3 |
| `agda-dev ../evidence/refuted/Refuted/Main.agda` | **7.8 s** | 7.8 s | 6 |
| `agda-dev ../evidence/probed/Probed/Main.agda` | **7.7 s** | 7.7 s | 9 |
| `agda-dev Rx/Evaluator/Domain.agda` | **7.5 s** | 10.8 s | 3 |
| `agda-dev ../evidence/refuted/Refuted/Carried-Derived.agda` | **7.4 s** | 7.4 s | 1 |
| `agda-dev Rx/Evaluator/Scan-Climb.agda` | **7.4 s** | 7.4 s | 2 |
...
| `agda-dev Rx/Obs-Depth.agda` | **6.9 s** | 7.2 s | 7 |
| `agda-dev Rx/Provenance-Theorems.agda` | **6.9 s** | 6.9 s | 1 |
| `agda-dev Rx/Obs-Depth/Eta-Cong.agda` | **6.8 s** | 8.0 s | 4 |
| `agda-dev Rx/Obs-Depth/Substitution.agda` | **6.7 s** | 7.9 s | 4 |
| `agda-dev Rx/Slots.agda` | **6.7 s** | 8.0 s | 2 |
| `agda-dev Implementation/Unit-Test.agda` | **6.6 s** | 6.6 s | 2 |
| `agda-dev Rx/Evaluator/Drops-Unconn.agda` | **6.5 s** | 9.9 s | 2 |
| `agda-dev CLI/IO.agda` | **6.4 s** | 6.4 s | 1 |
| `agda-dev Rx/Evaluator/Doorless.agda` | **6.4 s** | 6.4 s | 5 |
| `agda-dev Rx/Slot-Depth.agda` | **6.4 s** | 6.4 s | 3 |
| `agda-dev Rx/Evaluator/Unconn-Arith.agda` | **6.2 s** | 6.2 s | 1 |
| `agda-dev ../evidence/probed/Probed/Frame-Heads.agda` | **6.1 s** | 6.1 s | 1 |
...
| `agda-dev Rx/Strat-Order.agda` | **3.6 s** | 6.2 s | 6 |
