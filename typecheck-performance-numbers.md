...
| `agda-dev Verify-Budget-Sufficient/Wet/Part3.agda` | **268.7 s** | 268.7 s | 1 |
| `make agda (full gate, 85 modules)` | **114.0 s** | 114.0 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part4.agda` | **49.9 s** | 49.9 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Arms.agda` | **39.3 s** | 39.3 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Connect.agda` | **38.3 s** | 38.3 s | 1 |
...
| `make agda (full gate, 6 modules)` | **12.0 s** | 1180.0 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Burst-Walk.agda` | **9.2 s** | 16.8 s | 10 |
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **9.1 s** | 17.0 s | 6 |
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **8.7 s** | 24.6 s | 7 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Statement.agda` | **6.6 s** | 6.6 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Wet/Part1.agda` | **6.4 s** | 6.4 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Op-Budget.agda` | **5.2 s** | 5.2 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Psi-Split.agda` | **5.2 s** | 5.2 s | 4 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Chain.agda` | **4.6 s** | 4.6 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Caps-Nest.agda` | **4.6 s** | 4.6 s | 1 |
| `agda-dev Rx/Exp.agda` | **4.5 s** | 4.5 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Hop-Spine-Step.agda` | **4.4 s** | 6.8 s | 5 |
| `agda-dev Rx/Hop-Depth.agda` | **4.2 s** | 4.2 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Hop-Spine-Face.agda` | **4.2 s** | 5.0 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Hop-Spine-Push.agda` | **4.2 s** | 5.0 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Hop-Spine-Sub.agda` | **4.2 s** | 5.9 s | 2 |
| `agda-dev Readme-Theorems.agda` | **4.1 s** | 4.1 s | 1 |
| `agda-dev Harness/Main.agda` | **3.8 s** | 3.8 s | 6 |
| `agda-dev Verify-Budget-Sufficient/Demand-Probe-TEMP.agda` | **3.7 s** | 5.4 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Demand-Programs.agda` | **3.7 s** | 3.7 s | 1 |
...
<!-- AUTO:DATA {"agda-dev CLI/Decode.agda": {"best": 5.1, "last": 5.1, "runs": 1}, "agda-dev Harness/Main.agda": {"best": 3.8, "last": 3.8, "runs": 6}, "agda-dev QuickCheck.agda": {"best": 6.3, "last": 6.3, "runs": 1}, "agda-dev Readme-Theorems.agda": {"best": 4.1, "last": 4.1, "runs": 1}, "agda-dev Rx/Evaluator-Theorems.agda": {"best": 5.5, "last": 5.5, "runs": 1}, "agda-dev Rx/Evaluator.agda": {"best": 10.9, "last": 10.9, "runs": 1}, "agda-dev Rx/Exp.agda": {"best": 4.5, "last": 4.5, "runs": 2}, "agda-dev Rx/Frame-Width.agda": {"best": 4.7, "last": 4.7, "runs": 2}, "agda-dev Rx/Hop-Depth.agda": {"best": 4.2, "last": 4.2, "runs": 1}, "agda-dev Rx/Hop-Eta-Cong.agda": {"best": 3.4, "last": 3.4, "runs": 1}, "agda-dev Rx/Hop-Spine.agda": {"best": 3.5, "last": 3.5, "runs": 1}, "agda-dev Rx/Slot-Hop.agda": {"best": 3.3, "last": 3.3, "runs": 2}, "agda-dev Rx/Slots.agda": {"best": 5.0, "last": 5.0, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Burst-Walk.agda": {"best": 9.2, "last": 16.8, "runs": 10}, "agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda": {"best": 9.1, "last": 17.0, "runs": 6}, "agda-dev Verify-Budget-Sufficient/Caps-Chain.agda": {"best": 4.6, "last": 4.6, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Caps-Depth.agda": {"best": 13.1, "last": 13.1, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Caps-Face/Part1.agda": {"best": 6.4, "last": 6.4, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Caps-Face/Part4.agda": {"best": 49.9, "last": 49.9, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Caps-Face/Part5.agda": {"best": 6.2, "last": 6.2, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Caps-Face/Part6.agda": {"best": 18.5, "last": 18.5, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda": {"best": 8.1, "last": 9.6, "runs": 4}, "agda-dev Verify-Budget-Sufficient/Caps-Nest.agda": {"best": 4.6, "last": 4.6, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Caps.agda": {"best": 16.7, "last": 16.7, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Deliveries.agda": {"best": 4.9, "last": 4.9, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Delivery-Walk.agda": {"best": 9.4, "last": 9.4, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Demand-Probe-TEMP.agda": {"best": 3.7, "last": 5.4, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Demand-Probe.agda": {"best": 5.5, "last": 26.6, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Demand-Programs.agda": {"best": 3.7, "last": 3.7, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Hop-Spine-Face.agda": {"best": 4.2, "last": 5.0, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Hop-Spine-Push.agda": {"best": 4.2, "last": 5.0, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Hop-Spine-Step.agda": {"best": 4.4, "last": 6.8, "runs": 5}, "agda-dev Verify-Budget-Sufficient/Hop-Spine-Sub.agda": {"best": 4.2, "last": 5.9, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Init-Caps.agda": {"best": 5.2, "last": 5.2, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Keeps-Ring.agda": {"best": 11.0, "last": 11.0, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Measures.agda": {"best": 15.2, "last": 17.9, "runs": 7}, "agda-dev Verify-Budget-Sufficient/Node-Fresh.agda": {"best": 3.7, "last": 8.7, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Node-Table.agda": {"best": 3.5, "last": 3.5, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Op-Budget.agda": {"best": 5.2, "last": 5.2, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Psi-Split.agda": {"best": 5.2, "last": 5.2, "runs": 4}, "agda-dev Verify-Budget-Sufficient/Scan-Node-Probe.agda": {"best": 3.4, "last": 3.4, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Subscribe-Face.agda": {"best": 21.8, "last": 25.4, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Walk-Level.agda": {"best": 5.5, "last": 89.7, "runs": 24}, "agda-dev Verify-Budget-Sufficient/Walk-Level/Arms.agda": {"best": 39.3, "last": 39.3, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Walk-Level/Connect.agda": {"best": 38.3, "last": 38.3, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda": {"best": 8.7, "last": 24.6, "runs": 7}, "agda-dev Verify-Budget-Sufficient/Walk-Level/Statement.agda": {"best": 6.6, "last": 6.6, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Wet/Part1.agda": {"best": 6.4, "last": 6.4, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Wet/Part2.agda": {"best": 36.8, "last": 36.8, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Wet/Part3.agda": {"best": 268.7, "last": 268.7, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Wet/Part6.agda": {"best": 5.2, "last": 6.6, "runs": 4}, "agda-dev Verify-Well-Formed/Part1.agda": {"best": 7.3, "last": 7.3, "runs": 1}, "agda-dev Verify-Well-Formed/Part10.agda": {"best": 7.7, "last": 9.0, "runs": 3}, "agda-dev Verify-Well-Formed/Part11.agda": {"best": 7.4, "last": 7.4, "runs": 4}, "agda-dev Verify-Well-Formed/Part12.agda": {"best": 8.5, "last": 8.5, "runs": 2}, "agda-dev Verify-Well-Formed/Part13.agda": {"best": 7.5, "last": 8.7, "runs": 3}, "agda-dev Verify-Well-Formed/Part2.agda": {"best": 7.9, "last": 9.3, "runs": 2}, "agda-dev Verify-Well-Formed/Part3.agda": {"best": 6.4, "last": 7.2, "runs": 4}, "agda-dev Verify-Well-Formed/Part4.agda": {"best": 7.3, "last": 8.5, "runs": 4}, "agda-dev Verify-Well-Formed/Part5.agda": {"best": 7.3, "last": 7.3, "runs": 2}, "agda-dev Verify-Well-Formed/Part6.agda": {"best": 7.9, "last": 7.9, "runs": 1}, "agda-dev Verify-Well-Formed/Part7.agda": {"best": 7.5, "last": 7.5, "runs": 2}, "agda-dev Verify-Well-Formed/Part8.agda": {"best": 7.5, "last": 11.9, "runs": 4}, "agda-dev Verify-Well-Formed/Part9.agda": {"best": 8.7, "last": 8.7, "runs": 2}, "agda-dev Verify-Well-Formed/Root-Probe.agda": {"best": 6.5, "last": 7.7, "runs": 3}, "make agda (full gate, 14 modules)": {"best": 19.0, "last": 1889.0, "runs": 2}, "make agda (full gate, 15 modules)": {"best": 19.0, "last": 19.0, "runs": 3}, "make agda (full gate, 17 modules)": {"best": 22.0, "last": 22.0, "runs": 3}, "make agda (full gate, 174 modules)": {"best": 802.0, "last": 802.0, "runs": 1}, "make agda (full gate, 18 modules)": {"best": 28.0, "last": 33.0, "runs": 6}, "make agda (full gate, 19 modules)": {"best": 31.0, "last": 1203.0, "runs": 11}, "make agda (full gate, 2 modules)": {"best": 7.0, "last": 7.0, "runs": 1}, "make agda (full gate, 20 modules)": {"best": 32.0, "last": 32.0, "runs": 1}, "make agda (full gate, 21 modules)": {"best": 35.0, "last": 1187.0, "runs": 4}, "make agda (full gate, 22 modules)": {"best": 352.0, "last": 1312.0, "runs": 2}, "make agda (full gate, 23 modules)": {"best": 399.0, "last": 399.0, "runs": 1}, "make agda (full gate, 25 modules)": {"best": 1211.0, "last": 1211.0, "runs": 2}, "make agda (full gate, 28 modules)": {"best": 1448.0, "last": 1448.0, "runs": 1}, "make agda (full gate, 306 modules)": {"best": 1709.0, "last": 1709.0, "runs": 2}, "make agda (full gate, 32 modules)": {"best": 1642.0, "last": 1642.0, "runs": 1}, "make agda (full gate, 34 modules)": {"best": 669.0, "last": 669.0, "runs": 1}, "make agda (full gate, 35 modules)": {"best": 1633.0, "last": 1633.0, "runs": 1}, "make agda (full gate, 37 modules)": {"best": 1831.0, "last": 1831.0, "runs": 1}, "make agda (full gate, 4 modules)": {"best": 10.0, "last": 10.0, "runs": 2}, "make agda (full gate, 43 modules)": {"best": 1791.0, "last": 1791.0, "runs": 1}, "make agda (full gate, 45 modules)": {"best": 662.0, "last": 662.0, "runs": 1}, "make agda (full gate, 49 modules)": {"best": 743.0, "last": 743.0, "runs": 1}, "make agda (full gate, 50 modules)": {"best": 660.0, "last": 1935.0, "runs": 2}, "make agda (full gate, 51 modules)": {"best": 1980.0, "last": 1980.0, "runs": 1}, "make agda (full gate, 52 modules)": {"best": 1893.0, "last": 1893.0, "runs": 1}, "make agda (full gate, 54 modules)": {"best": 1788.0, "last": 1788.0, "runs": 1}, "make agda (full gate, 58 modules)": {"best": 2095.0, "last": 2095.0, "runs": 1}, "make agda (full gate, 59 modules)": {"best": 704.0, "last": 704.0, "runs": 1}, "make agda (full gate, 6 modules)": {"best": 12.0, "last": 1180.0, "runs": 2}, "make agda (full gate, 61 modules)": {"best": 1592.0, "last": 1592.0, "runs": 1}, "make agda (full gate, 7 modules)": {"best": 13.0, "last": 13.0, "runs": 1}, "make agda (full gate, 85 modules)": {"best": 114.0, "last": 114.0, "runs": 1}, "make agda (full gate, 9 modules)": {"best": 14.0, "last": 14.0, "runs": 2}} -->
...
- **THE PER-TIER REBUILD CONE — which is what "does the build get cheaper as we
  ...
  |---|---|---|
  | tier 0 | 23 mod / 234 s | **11 mod / 142 s** |
  | tier 1 | 30 mod / 292 s | **18 mod / 200 s** |
  | tier 2 | 14 mod / 102 s | 14 mod / 102 s |

  **It is not monotone: tier 1 is the most expensive tier, not tier 2.** Tier 1
