...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 768 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 255 |
...
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | >1 s | 150 |
...
| `agda-dev Verify-Budget-Sufficient/Depth-Sighted.agda` | **3.7 s** | 3.9 s | 3 |
