...
| `make agda (full gate, 19 modules)` | **31.0 s** | 1587.0 s | 10 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **10.1 s** | 10.1 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Statement.agda` | **7.9 s** | 7.9 s | 2 |
