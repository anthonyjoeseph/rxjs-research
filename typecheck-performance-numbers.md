...
| `make gate-heavy (full gate, 9 modules)` | **14.0 s** | 84.0 s | 6 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 934 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 74.5 s | 94 |
