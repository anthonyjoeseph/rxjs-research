...
| `agda-dev Verify-Budget-Sufficient/Walk-Level.agda` | **48.8 s** | 48.8 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Walk-Sink.agda` | **42.5 s** | 42.5 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Depth.agda` | **28.9 s** | 28.9 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Depth-Sighted.agda` | **27.7 s** | 27.7 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part2.agda` | **26.7 s** | 26.7 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Cascade-Nodes.agda` | **24.1 s** | 24.1 s | 1 |
| `agda-dev Rx/Evaluator.agda` | **23.2 s** | 23.2 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Keeps-Ring.agda` | **22.5 s** | 22.5 s | 1 |
...
| `agda-dev Main.agda` | **16.0 s** | 16.0 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **15.9 s** | 15.9 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Arrival-Caps.agda` | **15.4 s** | 15.4 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Nest-Store.agda` | **15.2 s** | 15.2 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Node-Fresh.agda` | **15.1 s** | 15.1 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Queue-Dead.agda` | **15.1 s** | 15.1 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Live-Nest-Walk.agda` | **14.0 s** | 14.0 s | 6 |
| `agda-dev Verify-Budget-Sufficient/Hop-Spine-Sub.agda` | **13.8 s** | 13.8 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Init-Nest.agda` | **13.7 s** | 13.7 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Ring-Vocabulary.agda` | **13.5 s** | 13.5 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Nest-Ceiling.agda` | **13.5 s** | 13.5 s | 1 |
| `agda-dev CLI/Decode.agda` | **13.3 s** | 13.3 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Cascade-Nest.agda` | **13.2 s** | 13.2 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Arrival-Ledger.agda` | **11.5 s** | 11.5 s | 1 |
