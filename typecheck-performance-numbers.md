...
| `agda-dev Rx/Evaluator.agda` | **19.4 s** | 23.5 s | 6 |
...
| `agda-dev QuickCheck.agda` | **10.6 s** | 26.0 s | 2 |
| `agda-dev ../evidence/refuted/Refuted/Main.agda` | **9.3 s** | 9.3 s | 5 |
| `agda-dev Verify-Well-Formed/Part7.agda` | **8.9 s** | 12.1 s | 2 |
| `agda-dev Verify-Well-Formed/Part12.agda` | **8.8 s** | 8.8 s | 1 |
| `agda-dev Verify-Well-Formed/Part8.agda` | **8.8 s** | 10.5 s | 2 |
| `agda-dev Verify-Well-Formed/Part9.agda` | **8.8 s** | 10.9 s | 2 |
| `agda-dev Verify-Rank-Sufficient/Fold-Path.agda` | **8.7 s** | 8.7 s | 1 |
| `agda-dev Rx/Exp.agda` | **8.6 s** | 10.2 s | 2 |
| `agda-dev Verify-Well-Formed/Part11.agda` | **8.5 s** | 10.5 s | 2 |
| `agda-dev Verify-Well-Formed/Part5.agda` | **8.4 s** | 10.7 s | 2 |
| `agda-dev CLI/Main.agda` | **8.3 s** | 8.3 s | 1 |
| `agda-dev Verify-Rank-Sufficient/Dry.agda` | **8.3 s** | 11.8 s | 4 |
| `agda-dev Verify-Rank-Sufficient/Push-Carried.agda` | **8.3 s** | 8.3 s | 1 |
| `agda-dev Verify-Rank-Sufficient/Path-Fits.agda` | **8.2 s** | 18.0 s | 4 |
| `agda-dev Verify-Well-Formed/Part1.agda` | **8.2 s** | 9.5 s | 2 |
| `agda-dev Rx/Rd-Slot-Cong.agda` | **8.1 s** | 8.1 s | 1 |
| `agda-dev Verify-Well-Formed/Part6.agda` | **8.1 s** | 9.4 s | 2 |
| `agda-dev Verify-Rank-Sufficient/Leaf-Carried.agda` | **8.0 s** | 8.0 s | 1 |
| `agda-dev Rx/Inputs-Below.agda` | **7.9 s** | 7.9 s | 1 |
| `agda-dev Verify-Well-Formed/Part10.agda` | **7.9 s** | 10.2 s | 2 |
| `agda-dev Verify-Rank-Sufficient/Carried.agda` | **7.8 s** | 8.4 s | 3 |
| `agda-dev Verify-Rank-Sufficient/Fits.agda` | **7.8 s** | 9.3 s | 3 |
| `agda-dev Verify-Well-Formed/Part2.agda` | **7.8 s** | 9.0 s | 4 |
| `agda-dev Verify-Well-Formed/Part4.agda` | **7.8 s** | 9.2 s | 2 |
| `agda-dev Verify-Rank-Sufficient.agda` | **7.7 s** | 8.9 s | 2 |
| `agda-dev Verify-Rank-Sufficient/Connect-Edge.agda` | **7.7 s** | 7.7 s | 1 |
| `agda-dev Verify-Rank-Sufficient/Dry-Emits.agda` | **7.7 s** | 7.7 s | 1 |
| `agda-dev Verify-Support/Queue-Dead.agda` | **7.7 s** | 7.7 s | 1 |
| `agda-dev Verify-Rank-Sufficient/Sync-Edge.agda` | **7.6 s** | 7.6 s | 1 |
| `agda-dev Rx/Hop-Depth.agda` | **7.5 s** | 8.7 s | 3 |
| `agda-dev Rx/Slot-Read.agda` | **7.5 s** | 7.5 s | 1 |
| `agda-dev Verify-Rank-Sufficient/Entry.agda` | **7.5 s** | 7.5 s | 2 |
| `agda-dev Verify-Support/Node-Fresh.agda` | **7.5 s** | 7.5 s | 1 |
| `agda-dev Verify-Support/Node-Table.agda` | **7.5 s** | 7.5 s | 1 |
| `agda-dev CLI/Encode.agda` | **7.3 s** | >2 s | 2 |
| `agda-dev Verify-Well-Formed/Part3.agda` | **7.3 s** | 9.2 s | 2 |
| `agda-dev Rx/Time-Theorems.agda` | **7.2 s** | 7.2 s | 1 |
| `agda-dev Readme-Theorems.agda` | **7.1 s** | 7.1 s | 1 |
| `agda-dev Rx/Evaluator-Theorems.agda` | **7.0 s** | 26.8 s | 3 |
...
| `agda-dev Rx/Prim.agda` | **3.6 s** | 5.6 s | 2 |
| `agda-dev Rx/Strat-Order.agda` | **3.6 s** | >2 s | 3 |
...
| `agda-dev Verify-Well-Formed/Part13.agda` | **1.0 s** | 10.7 s | 6 |

<!-- AUTO:DATA {"cloud|agda-dev ../evidence/probed/Probed/Apparatus.agda": {"best": 3.5, "last": 3.5, "runs": 1}, "cloud|agda-dev ../evidence/probed/Probed/Main.agda": {"best": 14.1, "floor": true, "last": 160.1, "runs": 8}, "cloud|agda-dev ../evidence/probed/Probed/Root.agda": {"best": 6.5, "last": 6.5, "runs": 1}, "cloud|agda-dev ../evidence/refuted/Refuted/Main.agda": {"best": 9.3, "last": 9.3, "runs": 5}, "cloud|agda-dev CLI/Decode.agda": {"best": 13.3, "last": 13.3, "runs": 1}, "cloud|agda-dev CLI/Encode.agda": {"best": 7.3, "floor": true, "last": 2.0, "runs": 2}, "cloud|agda-dev CLI/IO.agda": {"best": 6.4, "last": 6.4, "runs": 1}, "cloud|agda-dev CLI/JSON.agda": {"best": 3.5, "last": 3.5, "runs": 1}, "cloud|agda-dev CLI/Main.agda": {"best": 8.3, "last": 8.3, "runs": 1}, "cloud|agda-dev Decide.agda": {"best": 3.4, "last": 3.4, "runs": 1}, "cloud|agda-dev Implementation.agda": {"best": 3.5, "last": 3.5, "runs": 1}, "cloud|agda-dev Implementation/Unit-Test.agda": {"best": 6.6, "last": 6.6, "runs": 2}, "cloud|agda-dev Implementation/Unit-Test/Prelude.agda": {"best": 6.9, "last": 6.9, "runs": 1}, "cloud|agda-dev Main.agda": {"best": 16.0, "last": 67.2, "runs": 4}, "cloud|agda-dev QuickCheck.agda": {"best": 10.6, "last": 26.0, "runs": 2}, "cloud|agda-dev Readme-Theorems.agda": {"best": 7.1, "last": 7.1, "runs": 1}, "cloud|agda-dev Rx/Evaluator-Theorems.agda": {"best": 7.0, "last": 26.8, "runs": 3}, "cloud|agda-dev Rx/Evaluator.agda": {"best": 19.4, "last": 23.5, "runs": 6}, "cloud|agda-dev Rx/Exp.agda": {"best": 8.6, "last": 10.2, "runs": 2}, "cloud|agda-dev Rx/Hop-Depth.agda": {"best": 7.5, "last": 8.7, "runs": 3}, "cloud|agda-dev Rx/Inputs-Below.agda": {"best": 7.9, "last": 7.9, "runs": 1}, "cloud|agda-dev Rx/Prim.agda": {"best": 3.6, "last": 5.6, "runs": 2}, "cloud|agda-dev Rx/Protocol.agda": {"best": 3.8, "last": 3.8, "runs": 1}, "cloud|agda-dev Rx/Provenance-Theorems.agda": {"best": 6.9, "last": 6.9, "runs": 1}, "cloud|agda-dev Rx/Rd-Slot-Cong.agda": {"best": 8.1, "last": 8.1, "runs": 1}, "cloud|agda-dev Rx/Slot-Read.agda": {"best": 7.5, "last": 7.5, "runs": 1}, "cloud|agda-dev Rx/Slots.agda": {"best": 6.7, "last": 8.0, "runs": 2}, "cloud|agda-dev Rx/Strat-Order.agda": {"best": 3.6, "floor": true, "last": 2.0, "runs": 3}, "cloud|agda-dev Rx/Time-Theorems.agda": {"best": 7.2, "last": 7.2, "runs": 1}, "cloud|agda-dev Spec.agda": {"best": 3.5, "last": 3.5, "runs": 1}, "cloud|agda-dev Verify-Batch-Simultaneous/Batch-Theorems.agda": {"best": 5.0, "last": 5.0, "runs": 1}, "cloud|agda-dev Verify-Batch-Simultaneous/The-Proof.agda": {"best": 1.0, "floor": true, "last": 2.0, "runs": 83}, "cloud|agda-dev Verify-Rank-Sufficient.agda": {"best": 7.7, "last": 8.9, "runs": 2}, "cloud|agda-dev Verify-Rank-Sufficient/Carried.agda": {"best": 7.8, "last": 8.4, "runs": 3}, "cloud|agda-dev Verify-Rank-Sufficient/Connect-Edge.agda": {"best": 7.7, "last": 7.7, "runs": 1}, "cloud|agda-dev Verify-Rank-Sufficient/Dry-Emits.agda": {"best": 7.7, "last": 7.7, "runs": 1}, "cloud|agda-dev Verify-Rank-Sufficient/Dry.agda": {"best": 8.3, "last": 11.8, "runs": 4}, "cloud|agda-dev Verify-Rank-Sufficient/Entry.agda": {"best": 7.5, "last": 7.5, "runs": 2}, "cloud|agda-dev Verify-Rank-Sufficient/Fits.agda": {"best": 7.8, "last": 9.3, "runs": 3}, "cloud|agda-dev Verify-Rank-Sufficient/Fold-Path.agda": {"best": 8.7, "last": 8.7, "runs": 1}, "cloud|agda-dev Verify-Rank-Sufficient/Leaf-Carried.agda": {"best": 8.0, "last": 8.0, "runs": 1}, "cloud|agda-dev Verify-Rank-Sufficient/Path-Fits.agda": {"best": 8.2, "last": 18.0, "runs": 4}, "cloud|agda-dev Verify-Rank-Sufficient/Push-Carried.agda": {"best": 8.3, "last": 8.3, "runs": 1}, "cloud|agda-dev Verify-Rank-Sufficient/Sync-Edge.agda": {"best": 7.6, "last": 7.6, "runs": 1}, "cloud|agda-dev Verify-Support/Node-Fresh.agda": {"best": 7.5, "last": 7.5, "runs": 1}, "cloud|agda-dev Verify-Support/Node-Table.agda": {"best": 7.5, "last": 7.5, "runs": 1}, "cloud|agda-dev Verify-Support/Queue-Dead.agda": {"best": 7.7, "last": 7.7, "runs": 1}, "cloud|agda-dev Verify-Well-Formed/Part1.agda": {"best": 8.2, "last": 9.5, "runs": 2}, "cloud|agda-dev Verify-Well-Formed/Part10.agda": {"best": 7.9, "last": 10.2, "runs": 2}, "cloud|agda-dev Verify-Well-Formed/Part11.agda": {"best": 8.5, "last": 10.5, "runs": 2}, "cloud|agda-dev Verify-Well-Formed/Part12.agda": {"best": 8.8, "last": 8.8, "runs": 1}, "cloud|agda-dev Verify-Well-Formed/Part13.agda": {"best": 1.0, "last": 10.7, "runs": 6}, "cloud|agda-dev Verify-Well-Formed/Part2.agda": {"best": 7.8, "last": 9.0, "runs": 4}, "cloud|agda-dev Verify-Well-Formed/Part3.agda": {"best": 7.3, "last": 9.2, "runs": 2}, "cloud|agda-dev Verify-Well-Formed/Part4.agda": {"best": 7.8, "last": 9.2, "runs": 2}, "cloud|agda-dev Verify-Well-Formed/Part5.agda": {"best": 8.4, "last": 10.7, "runs": 2}, "cloud|agda-dev Verify-Well-Formed/Part6.agda": {"best": 8.1, "last": 9.4, "runs": 2}, "cloud|agda-dev Verify-Well-Formed/Part7.agda": {"best": 8.9, "last": 12.1, "runs": 2}, "cloud|agda-dev Verify-Well-Formed/Part8.agda": {"best": 8.8, "last": 10.5, "runs": 2}, "cloud|agda-dev Verify-Well-Formed/Part9.agda": {"best": 8.8, "last": 10.9, "runs": 2}, "cloud|make gate-heavy (full gate, 13 modules)": {"best": 64.0, "last": 64.0, "runs": 1}, "cloud|make gate-heavy (full gate, 24 modules)": {"best": 2643.0, "last": 2643.0, "runs": 1}, "cloud|make gate-heavy (full gate, 326 modules)": {"best": 3374.0, "last": 3374.0, "runs": 1}, "cloud|make gate-heavy (full gate, 37 modules)": {"best": 2476.0, "last": 2476.0, "runs": 1}, "cloud|make gate-heavy (full gate, 51 modules)": {"best": 3917.0, "last": 3917.0, "runs": 1}, "local|agda-dev CLI/Decode.agda": {"best": 5.1, "last": 5.1, "runs": 1}, "local|agda-dev Decide.agda": {"best": 1.6, "last": 1.6, "runs": 1}, "local|agda-dev Main.agda": {"best": 45.0, "floor": true, "last": 45.0, "runs": 1}, "local|agda-dev QuickCheck.agda": {"best": 5.3, "last": 5.3, "runs": 2}, "local|agda-dev Readme-Theorems.agda": {"best": 4.1, "last": 4.1, "runs": 1}, "local|agda-dev Rx/Evaluator-Theorems.agda": {"best": 5.5, "last": 5.5, "runs": 1}, "local|agda-dev Rx/Evaluator.agda": {"best": 7.7, "last": 7.7, "runs": 2}, "local|agda-dev Rx/Exp.agda": {"best": 3.2, "last": 3.2, "runs": 3}, "local|agda-dev Rx/Slots.agda": {"best": 2.5, "last": 2.5, "runs": 3}, "local|agda-dev Verify-Batch-Simultaneous/The-Proof.agda": {"best": 7.0, "floor": true, "last": 2.0, "runs": 1023}, "local|agda-dev Verify-Well-Formed/Part1.agda": {"best": 3.4, "last": 3.4, "runs": 2}, "local|agda-dev Verify-Well-Formed/Part10.agda": {"best": 7.7, "last": 9.0, "runs": 3}, "local|agda-dev Verify-Well-Formed/Part11.agda": {"best": 7.4, "last": 7.4, "runs": 4}, "local|agda-dev Verify-Well-Formed/Part12.agda": {"best": 8.5, "last": 8.5, "runs": 2}, "local|agda-dev Verify-Well-Formed/Part13.agda": {"best": 5.3, "floor": true, "last": 1.0, "runs": 164}, "local|agda-dev Verify-Well-Formed/Part2.agda": {"best": 3.1, "last": 3.1, "runs": 3}, "local|agda-dev Verify-Well-Formed/Part3.agda": {"best": 3.0, "last": 3.1, "runs": 7}, "local|agda-dev Verify-Well-Formed/Part4.agda": {"best": 7.3, "last": 8.5, "runs": 4}, "local|agda-dev Verify-Well-Formed/Part5.agda": {"best": 7.3, "last": 7.3, "runs": 2}, "local|agda-dev Verify-Well-Formed/Part6.agda": {"best": 7.9, "last": 7.9, "runs": 1}, "local|agda-dev Verify-Well-Formed/Part7.agda": {"best": 7.5, "last": 7.5, "runs": 2}, "local|agda-dev Verify-Well-Formed/Part8.agda": {"best": 3.5, "last": 3.5, "runs": 5}, "local|agda-dev Verify-Well-Formed/Part9.agda": {"best": 8.7, "last": 8.7, "runs": 2}, "local|make gate-heavy (full gate, 1 modules)": {"best": 5.0, "last": 7.0, "runs": 3}, "local|make gate-heavy (full gate, 10 modules)": {"best": 65.0, "last": 65.0, "runs": 5}, "local|make gate-heavy (full gate, 11 modules)": {"best": 18.0, "last": 1052.0, "runs": 9}, "local|make gate-heavy (full gate, 12 modules)": {"best": 375.0, "last": 1107.0, "runs": 5}, "local|make gate-heavy (full gate, 13 modules)": {"best": 88.0, "last": 1106.0, "runs": 5}, "local|make gate-heavy (full gate, 14 modules)": {"best": 19.0, "last": 1889.0, "runs": 2}, "local|make gate-heavy (full gate, 15 modules)": {"best": 19.0, "last": 80.0, "runs": 5}, "local|make gate-heavy (full gate, 16 modules)": {"best": 15.0, "last": 1101.0, "runs": 6}, "local|make gate-heavy (full gate, 17 modules)": {"best": 12.0, "last": 1495.0, "runs": 7}, "local|make gate-heavy (full gate, 174 modules)": {"best": 802.0, "last": 802.0, "runs": 1}, "local|make gate-heavy (full gate, 18 modules)": {"best": 28.0, "last": 278.0, "runs": 8}, "local|make gate-heavy (full gate, 19 modules)": {"best": 31.0, "last": 1203.0, "runs": 11}, "local|make gate-heavy (full gate, 2 modules)": {"best": 7.0, "last": 7.0, "runs": 1}, "local|make gate-heavy (full gate, 20 modules)": {"best": 32.0, "last": 32.0, "runs": 1}, "local|make gate-heavy (full gate, 21 modules)": {"best": 35.0, "last": 1697.0, "runs": 5}, "local|make gate-heavy (full gate, 22 modules)": {"best": 352.0, "last": 1312.0, "runs": 2}, "local|make gate-heavy (full gate, 23 modules)": {"best": 399.0, "last": 399.0, "runs": 1}, "local|make gate-heavy (full gate, 24 modules)": {"best": 1368.0, "last": 1368.0, "runs": 2}, "local|make gate-heavy (full gate, 25 modules)": {"best": 1211.0, "last": 1486.0, "runs": 3}, "local|make gate-heavy (full gate, 26 modules)": {"best": 1297.0, "last": 1297.0, "runs": 1}, "local|make gate-heavy (full gate, 28 modules)": {"best": 1448.0, "last": 1448.0, "runs": 1}, "local|make gate-heavy (full gate, 29 modules)": {"best": 1298.0, "last": 1298.0, "runs": 1}, "local|make gate-heavy (full gate, 3 modules)": {"best": 9.0, "last": 9.0, "runs": 1}, "local|make gate-heavy (full gate, 30 modules)": {"best": 1342.0, "last": 1342.0, "runs": 2}, "local|make gate-heavy (full gate, 306 modules)": {"best": 1709.0, "last": 1709.0, "runs": 2}, "local|make gate-heavy (full gate, 32 modules)": {"best": 1642.0, "last": 1642.0, "runs": 1}, "local|make gate-heavy (full gate, 34 modules)": {"best": 669.0, "last": 669.0, "runs": 1}, "local|make gate-heavy (full gate, 35 modules)": {"best": 1633.0, "last": 1633.0, "runs": 1}, "local|make gate-heavy (full gate, 36 modules)": {"best": 1338.0, "last": 1338.0, "runs": 1}, "local|make gate-heavy (full gate, 37 modules)": {"best": 1831.0, "last": 1831.0, "runs": 1}, "local|make gate-heavy (full gate, 38 modules)": {"best": 1477.0, "last": 1477.0, "runs": 1}, "local|make gate-heavy (full gate, 4 modules)": {"best": 9.0, "last": 11.0, "runs": 4}, "local|make gate-heavy (full gate, 43 modules)": {"best": 1791.0, "last": 1791.0, "runs": 1}, "local|make gate-heavy (full gate, 45 modules)": {"best": 662.0, "last": 662.0, "runs": 1}, "local|make gate-heavy (full gate, 46 modules)": {"best": 1407.0, "last": 1407.0, "runs": 1}, "local|make gate-heavy (full gate, 49 modules)": {"best": 743.0, "last": 743.0, "runs": 1}, "local|make gate-heavy (full gate, 5 modules)": {"best": 9.0, "last": 13.0, "runs": 6}, "local|make gate-heavy (full gate, 50 modules)": {"best": 660.0, "last": 1760.0, "runs": 4}, "local|make gate-heavy (full gate, 51 modules)": {"best": 1980.0, "last": 1980.0, "runs": 1}, "local|make gate-heavy (full gate, 52 modules)": {"best": 1893.0, "last": 1893.0, "runs": 1}, "local|make gate-heavy (full gate, 54 modules)": {"best": 1788.0, "last": 1788.0, "runs": 1}, "local|make gate-heavy (full gate, 55 modules)": {"best": 3004.0, "last": 3004.0, "runs": 1}, "local|make gate-heavy (full gate, 58 modules)": {"best": 2095.0, "last": 2095.0, "runs": 1}, "local|make gate-heavy (full gate, 59 modules)": {"best": 704.0, "last": 704.0, "runs": 1}, "local|make gate-heavy (full gate, 6 modules)": {"best": 10.0, "last": 34.0, "runs": 8}, "local|make gate-heavy (full gate, 61 modules)": {"best": 1592.0, "last": 1592.0, "runs": 1}, "local|make gate-heavy (full gate, 69 modules)": {"best": 1578.0, "last": 1578.0, "runs": 1}, "local|make gate-heavy (full gate, 7 modules)": {"best": 13.0, "last": 37.0, "runs": 11}, "local|make gate-heavy (full gate, 70 modules)": {"best": 1583.0, "last": 1583.0, "runs": 1}, "local|make gate-heavy (full gate, 77 modules)": {"best": 1658.0, "last": 1658.0, "runs": 1}, "local|make gate-heavy (full gate, 8 modules)": {"best": 38.0, "last": 38.0, "runs": 6}, "local|make gate-heavy (full gate, 85 modules)": {"best": 114.0, "last": 114.0, "runs": 1}, "local|make gate-heavy (full gate, 9 modules)": {"best": 14.0, "last": 38.0, "runs": 7}} -->
