...
| `agda-dev Rx/Evaluator/Freshness/Preserve.agda` | **13.6 s** | 13.6 s | 2 |
...
| `agda-dev Rx/Evaluator/Keeps-Slots.agda` | **8.8 s** | 8.8 s | 3 |
...
| `agda-dev Rx/Evaluator/Reducible.agda` | **6.2 s** | 10.4 s | 51 |
