...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Connect.agda` | **25.9 s** | 27.8 s | 20 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **8.7 s** | 17.7 s | 26 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | 7.8 s | 340 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | 7.3 s | 125 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part3.agda` | **6.0 s** | 6.0 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Arms.agda` | **5.6 s** | 7.2 s | 24 |
...
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | 6.1 s | 71 |
