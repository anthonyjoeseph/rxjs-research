...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **141.0 s** | 141.0 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Chain-Caps-OK.agda` | **12.7 s** | 12.7 s | 1 |
