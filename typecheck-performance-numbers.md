...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **8.7 s** | 15.5 s | 5 |
...
| `agda-dev Verify-Budget-Sufficient/Psi-Split.agda` | **5.6 s** | 5.6 s | 1 |
| `agda-dev Rx/Evaluator-Theorems.agda` | **5.5 s** | 5.5 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Demand-Probe.agda` | **5.5 s** | 26.6 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Walk-Level.agda` | **5.5 s** | 70.9 s | 23 |
