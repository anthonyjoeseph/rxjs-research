...
| `agda-dev Rx/Evaluator/Keeps.agda` | **17.9 s** | 17.9 s | 4 |
| `agda-dev Rx/Exp/ValEq.agda` | **13.6 s** | 13.6 s | 1 |
| `agda-dev QuickCheck.agda` | **10.6 s** | 18.2 s | 8 |
| `agda-dev Implementation/Unit-Test/Bug-Cache.agda` | **8.0 s** | >1 s | 4 |
| `agda-dev Rx/Evaluator/Domain.agda` | **7.5 s** | 22.1 s | 9 |
...
| `agda-dev Rx/Evaluator/Unconn-Arith.agda` | **6.3 s** | 6.3 s | 1 |
| `agda-dev Rx/Evaluator.agda` | **6.1 s** | 7.8 s | 19 |
...
| `agda-dev Rx/Evaluator/Reducible.agda` | **5.6 s** | 45.4 s | 69 |
