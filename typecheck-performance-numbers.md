...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **102.1 s** | 210.6 s | 20 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level.agda` | **45.2 s** | 78.3 s | 4 |
...
| `agda-dev Verify-Budget-Sufficient/Subscribe-Face.agda` | **36.5 s** | 76.1 s | 4 |
...
| `agda-dev Verify-Budget-Sufficient/Burst-Walk.agda` | **24.3 s** | 24.3 s | 10 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part6.agda` | **21.3 s** | 38.1 s | 5 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part1.agda` | **10.6 s** | 17.2 s | 11 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part5.agda` | **9.8 s** | 15.2 s | 6 |
