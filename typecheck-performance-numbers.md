...
| `agda-dev Verify-Budget-Sufficient/Burst-Walk.agda` | **29.3 s** | >160 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Cascade-Caps.agda` | **10.7 s** | 17.7 s | 4 |
