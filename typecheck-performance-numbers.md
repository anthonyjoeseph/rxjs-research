...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **106.8 s** | >160 s | 7 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Walk-Sink.agda` | **34.2 s** | 34.2 s | 8 |
