...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Statement.agda` | **4.8 s** | 4.8 s | 5 |
...
| `agda-dev Verify-Budget-Sufficient/Depth-Bound.agda` | **4.4 s** | 4.4 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Wet/Part6.agda` | **4.4 s** | 4.4 s | 5 |
| `agda-dev Rx/Hop-Depth.agda` | **4.2 s** | 4.2 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Depth-Compositional.agda` | **4.2 s** | 4.2 s | 1 |
