...
| `agda-dev Verify-Budget-Sufficient/Measures.agda` | **32.3 s** | 32.3 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part4.agda` | **22.1 s** | 65.1 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part5.agda` | **11.6 s** | 25.9 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Hop-Spine-Step.agda` | **11.6 s** | 11.6 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Init-Caps.agda` | **11.6 s** | 17.7 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part1.agda` | **11.0 s** | 11.0 s | 2 |
