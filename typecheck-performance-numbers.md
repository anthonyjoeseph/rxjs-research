...
| `agda-dev Rx/Evaluator/Builder.agda` | **13.2 s** | 13.7 s | 12 |
| `agda-dev Rx/Evaluator/Freshness/Mono.agda` | **12.5 s** | 16.5 s | 4 |
| `agda-dev QuickCheck.agda` | **10.6 s** | 22.9 s | 7 |
...
| `agda-dev CLI/Decode.agda` | **7.0 s** | 7.0 s | 5 |
| `agda-dev Rx/Evaluator-Theorems.agda` | **7.0 s** | 8.0 s | 4 |
| `agda-dev Rx/Exp.agda` | **7.0 s** | 16.9 s | 7 |
...
| `agda-dev Implementation/Unit-Test/Prelude.agda` | **6.6 s** | 6.6 s | 2 |
| `agda-dev CLI/IO.agda` | **6.4 s** | 6.4 s | 1 |
| `agda-dev Verify-Well-Formed.agda` | **6.4 s** | >1 s | 13 |
| `agda-dev Rx/Evaluator.agda` | **6.3 s** | 6.9 s | 13 |
| `agda-dev Rx/Evaluator/Reducible.agda` | **6.2 s** | 10.9 s | 54 |
| `agda-dev Rx/Depth.agda` | **6.1 s** | 7.2 s | 2 |
