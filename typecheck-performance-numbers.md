...
| `agda-dev Rx/Evaluator/Freshness.agda` | **8.7 s** | 8.7 s | 1 |
| `agda-dev CLI/Main.agda` | **8.3 s** | >2 s | 2 |
| `agda-dev Implementation/Unit-Test/Bug-Cache.agda` | **8.3 s** | >1 s | 2 |
...
| `agda-dev Implementation/Unit-Test.agda` | **6.6 s** | >1 s | 5 |
| `agda-dev Implementation/Unit-Test/Prelude.agda` | **6.6 s** | >1 s | 3 |
