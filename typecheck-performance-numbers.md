...
| `agda-dev ../evidence/probed/Probed/Chain-Step-Regs-Read.agda` | **152.7 s** | 152.7 s | 2 |
| `agda-dev ../evidence/probed/Probed/Fold-Regs-Nest-Cross.agda` | **139.9 s** | 139.9 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **106.8 s** | 124.1 s | 4 |
...
| `agda-dev ../evidence/probed/Probed/Fold-Regs-Nest-Grid.agda` | **57.7 s** | 57.7 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Measures.agda` | **42.2 s** | 42.2 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Nest-Walk/Share-Fold.agda` | **40.0 s** | 41.0 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Subscribe-Face.agda` | **36.5 s** | 36.5 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Walk-Sink.agda` | **34.3 s** | 34.3 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part4.agda` | **22.1 s** | 22.1 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part6.agda` | **21.3 s** | 24.7 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Caps-Depth.agda` | **20.4 s** | 20.4 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Cascade-Nodes.agda` | **19.8 s** | 23.2 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Delivery-Walk.agda` | **19.5 s** | 19.5 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Keeps-Ring.agda` | **17.8 s** | 17.8 s | 2 |
| `agda-dev ../evidence/probed/Probed/Fold-Regs-Nest-Spine.agda` | **16.2 s** | 16.2 s | 1 |
| `agda-dev Main.agda` | **16.0 s** | 67.2 s | 4 |
| `agda-dev Verify-Budget-Sufficient/Desc-Ceil.agda` | **15.3 s** | 15.3 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Nest-Store.agda` | **15.2 s** | 15.2 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Node-Fresh.agda` | **14.9 s** | 14.9 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Nest-Subst.agda` | **14.7 s** | 14.7 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Frame-Face.agda` | **14.5 s** | 14.5 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part3.agda` | **14.4 s** | 32.2 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Arrival-Caps.agda` | **14.4 s** | 14.4 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 20.9 s | 12 |
| `agda-dev Verify-Budget-Sufficient/Nest-Ceiling.agda` | **13.5 s** | 13.5 s | 1 |
| `agda-dev ../evidence/probed/Probed/Thru-Step-Indexed.agda` | **13.3 s** | 13.3 s | 1 |
| `agda-dev CLI/Decode.agda` | **13.3 s** | 13.3 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Cascade-Nest.agda` | **12.9 s** | 12.9 s | 2 |
| `agda-dev ../evidence/refuted/Refuted/Fold-Path-Regs-Len.agda` | **12.7 s** | 12.7 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Nest-Cap.agda` | **12.6 s** | 12.6 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Nest-Arith.agda` | **12.2 s** | 13.3 s | 4 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Chain-Caps-OK.agda` | **12.2 s** | 12.2 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Cascade-Caps.agda` | **11.7 s** | 11.7 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Ring-Vocabulary.agda` | **11.7 s** | 11.7 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part5.agda` | **11.6 s** | 11.6 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Hop-Spine-Step.agda` | **11.6 s** | 11.6 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Init-Caps.agda` | **11.6 s** | 11.6 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Arrival-Ledger.agda` | **11.3 s** | 11.3 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Nodes-Nest-Walk.agda` | **11.3 s** | 13.8 s | 3 |
| `agda-dev ../evidence/probed/Probed/Fold-Regs-Two-Caps.agda` | **11.2 s** | 11.2 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part1.agda` | **11.2 s** | 11.2 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Wet/Part1.agda` | **11.1 s** | 11.1 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Regs-Fold-Len.agda` | **10.9 s** | 10.9 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Cascade-Live.agda` | **10.8 s** | 10.8 s | 1 |
| `agda-dev ../evidence/probed/Probed/Fold-Regs-Reentrant.agda` | **10.7 s** | 10.7 s | 2 |
| `agda-dev ../evidence/probed/Probed/Frame-Step-Regs-Level.agda` | **10.6 s** | 10.6 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **10.4 s** | 15.4 s | 11 |
...
| `agda-dev Verify-Budget-Sufficient/Fan-Caps.agda` | **10.2 s** | 10.2 s | 1 |
...
| `agda-dev ../evidence/probed/Probed/Chain-Step-Regs-Inner.agda` | **8.2 s** | 8.2 s | 1 |
...
| `agda-dev ../evidence/probed/Probed/Chain-Step-Regs-Ops.agda` | **7.6 s** | 7.6 s | 3 |
...
| `agda-dev Harness/Main.agda` | **7.2 s** | 7.2 s | 1 |
