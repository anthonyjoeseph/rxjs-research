...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | 9.9 s | 293 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **102.1 s** | 179.7 s | 22 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **47.4 s** | 74.0 s | 5 |
| `agda-dev Verify-Budget-Sufficient/Walk-Level.agda` | **45.2 s** | >164 s | 5 |
...
| `agda-dev Verify-Budget-Sufficient/Subscribe-Face.agda` | **36.5 s** | 46.7 s | 5 |
