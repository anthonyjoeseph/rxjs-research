...
| `agda-dev Rx/Evaluator/Reducible.agda` | **6.6 s** | >2 s | 14 |
| `agda-dev CLI/IO.agda` | **6.4 s** | 6.4 s | 1 |
| `agda-dev ../evidence/probed/Probed/Reducible-Arms.agda` | **5.9 s** | 5.9 s | 1 |
