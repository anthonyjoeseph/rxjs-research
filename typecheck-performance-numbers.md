...
| `agda-dev Verify-Budget-Sufficient/Walk-Level.agda` | **45.2 s** | 45.2 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Burst-Walk/Burst-Face.agda` | **20.2 s** | 25.7 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Burst-Walk/Leaves.agda` | **19.7 s** | >160 s | 2 |
