...
| `agda-dev Rx/Evaluator/Builder.agda` | **13.8 s** | 16.1 s | 5 |
...
| `agda-dev Rx/Evaluator/Burst-Report.agda` | **8.0 s** | 10.8 s | 4 |
...
| `agda-dev ../evidence/probed/Probed/Eval-Open.agda` | **6.9 s** | 6.9 s | 1 |
| `agda-dev Implementation/Unit-Test/Prelude.agda` | **6.9 s** | 6.9 s | 1 |
| `agda-dev Rx/Obs-Depth.agda` | **6.9 s** | 6.9 s | 5 |
| `agda-dev Rx/Provenance-Theorems.agda` | **6.9 s** | 6.9 s | 1 |
| `agda-dev Rx/Obs-Depth/Eta-Cong.agda` | **6.8 s** | 6.8 s | 3 |
...
| `agda-dev Rx/Slot-Depth.agda` | **6.6 s** | 6.6 s | 1 |
