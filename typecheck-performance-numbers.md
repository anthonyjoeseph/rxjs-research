...
| `agda-dev ../evidence/probed/Probed/Main.agda` | **114.4 s** | 114.4 s | 1 |
...
| `agda-dev ../evidence/refuted/Refuted/Main.agda` | **22.5 s** | 22.5 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 48.6 s | 34 |
| `agda-dev ../evidence/probed/Probed/Thru-Step-Indexed.agda` | **13.3 s** | 13.3 s | 1 |
| `agda-dev CLI/Decode.agda` | **13.3 s** | 13.3 s | 1 |
| `agda-dev ../evidence/probed/Probed/Cross-Count-Store.agda` | **13.1 s** | 13.1 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Nodes-Nest-Walk.agda` | **11.3 s** | 11.3 s | 5 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Chain-Caps-OK.agda` | **11.2 s** | 12.9 s | 8 |
...
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **10.4 s** | 17.4 s | 20 |
