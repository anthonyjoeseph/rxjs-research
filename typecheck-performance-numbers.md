...
| `make gate-heavy (full gate, 8 modules)` | **41.0 s** | 75.0 s | 5 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 834 |
