...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **102.1 s** | >160 s | 13 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 53.6 s | 40 |
...
| `agda-dev ../evidence/probed/Probed/Frame-Drain-Live.agda` | **12.6 s** | 12.6 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Cascade-Nest.agda` | **12.0 s** | 12.0 s | 4 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Cascade-Caps.agda` | **10.7 s** | 10.7 s | 3 |
...
| `agda-dev ../evidence/refuted/Refuted/Walk-Ceil-Drain.agda` | **10.0 s** | 10.0 s | 2 |
...
| `agda-dev ../evidence/refuted/Refuted/Size-Climb-Afford.agda` | **9.7 s** | 9.7 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Cascade-Live.agda` | **9.5 s** | 9.5 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Fold-Room.agda` | **9.5 s** | 13.1 s | 2 |
| `agda-dev ../evidence/refuted/Refuted/Walk-Ceil-Ledger.agda` | **9.4 s** | 9.7 s | 4 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Store.agda` | **8.2 s** | 15.9 s | 6 |
