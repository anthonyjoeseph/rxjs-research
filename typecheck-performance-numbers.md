...
| `agda-dev Rx/Evaluator/Freshness/Preserve.agda` | **13.6 s** | 19.6 s | 3 |
| `agda-dev Rx/Evaluator/Builder.agda` | **13.2 s** | 21.7 s | 11 |
| `agda-dev Rx/Evaluator/Freshness/Mono.agda` | **12.5 s** | 12.5 s | 3 |
| `agda-dev QuickCheck.agda` | **10.6 s** | 29.4 s | 6 |
| `agda-dev Rx/Evaluator/Keeps-Slots.agda` | **8.8 s** | 11.5 s | 4 |
| `agda-dev ../evidence/probed/Probed/Readme-Claims.agda` | **8.4 s** | 8.4 s | 1 |
| `agda-dev CLI/Main.agda` | **8.3 s** | >2 s | 2 |
| `agda-dev Implementation/Unit-Test/Bug-Cache.agda` | **8.3 s** | 8.3 s | 1 |
| `agda-dev CLI/Decode.agda` | **8.0 s** | 10.2 s | 3 |
| `agda-dev ../evidence/probed/Probed/Pipeline-Claims.agda` | **7.8 s** | 7.8 s | 2 |
| `agda-dev Rx/Subst-Ren-Fuse.agda` | **7.8 s** | 9.4 s | 4 |
| `agda-dev Rx/Evaluator/Domain.agda` | **7.5 s** | 10.8 s | 5 |
| `agda-dev Rx/Subst-Elim-Weak.agda` | **7.5 s** | 10.0 s | 7 |
| `agda-dev ../evidence/probed/Probed/Main.agda` | **7.2 s** | 7.2 s | 10 |
| `agda-dev Rx/Time-Theorems.agda` | **7.2 s** | 7.2 s | 1 |
| `agda-dev Rx/Inputs-Below.agda` | **7.1 s** | 9.1 s | 4 |
| `agda-dev Rx/Evaluator-Theorems.agda` | **7.0 s** | 8.0 s | 4 |
| `agda-dev Rx/Exp.agda` | **7.0 s** | 16.8 s | 5 |
...
| `agda-dev Readme-Theorems.agda` | **6.8 s** | 6.8 s | 2 |
| `agda-dev Rx/Slots.agda` | **6.7 s** | 8.0 s | 2 |
| `agda-dev Verify-Run-Monotone.agda` | **6.7 s** | 6.7 s | 1 |
| `agda-dev Implementation/Unit-Test.agda` | **6.6 s** | 7.6 s | 3 |
| `agda-dev Rx/Subst-Elim.agda` | **6.5 s** | 11.2 s | 3 |
| `agda-dev Verify-Determinacy.agda` | **6.5 s** | 6.5 s | 1 |
| `agda-dev CLI/IO.agda` | **6.4 s** | 6.4 s | 1 |
| `agda-dev Rx/Subst-Renaming.agda` | **6.4 s** | 8.8 s | 4 |
| `agda-dev Verify-Well-Formed.agda` | **6.4 s** | >1 s | 13 |
| `agda-dev Rx/Evaluator.agda` | **6.3 s** | 9.1 s | 12 |
| `agda-dev Rx/Evaluator/Reducible.agda` | **6.2 s** | 13.1 s | 52 |
| `agda-dev Rx/Subst-Split.agda` | **6.1 s** | 6.1 s | 2 |
| `agda-dev Rx/SExp.agda` | **6.0 s** | 6.0 s | 1 |
| `agda-dev Rx/Subst-Eval.agda` | **6.0 s** | 12.3 s | 5 |
| `agda-dev ../evidence/refuted/Refuted/Main.agda` | **5.9 s** | 5.9 s | 7 |
| `agda-dev CLI/Encode.agda` | **5.9 s** | 5.9 s | 4 |
| `agda-dev Rx/Envelope.agda` | **5.9 s** | 5.9 s | 1 |
| `agda-dev Rx/Evaluator/Freshness.agda` | **5.7 s** | 5.7 s | 3 |
| `agda-dev Rx/Exp/Guarded.agda` | **5.6 s** | 8.0 s | 2 |
| `agda-dev Rx/Subst-Compose.agda` | **5.6 s** | 8.7 s | 4 |
| `agda-dev Rx/Subst-Transport.agda` | **5.6 s** | 8.2 s | 4 |
| `agda-dev Rx/Subst-Identity.agda` | **5.5 s** | 7.7 s | 6 |
| `agda-dev Rx/Elaborate.agda` | **5.4 s** | 6.5 s | 2 |
...
| `agda-dev Rx/Protocol/Sound.agda` | **3.0 s** | 3.0 s | 3 |
| `agda-dev Rx/Mint.agda` | **2.6 s** | 3.0 s | 4 |
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **1.0 s** | 11.5 s | 90 |

<!-- AUTO:DATA {"cloud|agda-dev ../evidence/probed/Probed/Apparatus.agda": {"best": 3.5, "last": 3.5, "runs": 1}, "cloud|agda-dev ../evidence/probed/Probed/Main.agda": {"best": 7.2, "last": 7.2, "runs": 10}, "cloud|agda-dev ../evidence/probed/Probed/Pipeline-Claims.agda": {"best": 7.8, "last": 7.8, "runs": 2}, "cloud|agda-dev ../evidence/probed/Probed/Readme-Claims.agda": {"best": 8.4, "last": 8.4, "runs": 1}, "cloud|agda-dev ../evidence/refuted/Refuted/Main.agda": {"best": 5.9, "last": 5.9, "runs": 7}, "cloud|agda-dev CLI/Decode.agda": {"best": 8.0, "last": 10.2, "runs": 3}, "cloud|agda-dev CLI/Encode.agda": {"best": 5.9, "last": 5.9, "runs": 4}, "cloud|agda-dev CLI/IO.agda": {"best": 6.4, "last": 6.4, "runs": 1}, "cloud|agda-dev CLI/JSON.agda": {"best": 3.5, "last": 3.5, "runs": 1}, "cloud|agda-dev CLI/Main.agda": {"best": 8.3, "floor": true, "last": 2.0, "runs": 2}, "cloud|agda-dev Decide.agda": {"best": 3.4, "last": 3.4, "runs": 1}, "cloud|agda-dev Implementation.agda": {"best": 3.5, "last": 3.5, "runs": 1}, "cloud|agda-dev Implementation/Unit-Test.agda": {"best": 6.6, "last": 7.6, "runs": 3}, "cloud|agda-dev Implementation/Unit-Test/Bug-Cache.agda": {"best": 8.3, "last": 8.3, "runs": 1}, "cloud|agda-dev Implementation/Unit-Test/Prelude.agda": {"best": 6.9, "last": 6.9, "runs": 1}, "cloud|agda-dev Main.agda": {"best": 6.8, "last": 6.8, "runs": 7}, "cloud|agda-dev QuickCheck.agda": {"best": 10.6, "last": 29.4, "runs": 6}, "cloud|agda-dev Readme-Theorems.agda": {"best": 6.8, "last": 6.8, "runs": 2}, "cloud|agda-dev Rx/Elaborate.agda": {"best": 5.4, "last": 6.5, "runs": 2}, "cloud|agda-dev Rx/Envelope.agda": {"best": 5.9, "last": 5.9, "runs": 1}, "cloud|agda-dev Rx/Evaluator-Theorems.agda": {"best": 7.0, "last": 8.0, "runs": 4}, "cloud|agda-dev Rx/Evaluator.agda": {"best": 6.3, "last": 9.1, "runs": 12}, "cloud|agda-dev Rx/Evaluator/Builder.agda": {"best": 13.2, "last": 21.7, "runs": 11}, "cloud|agda-dev Rx/Evaluator/Domain.agda": {"best": 7.5, "last": 10.8, "runs": 5}, "cloud|agda-dev Rx/Evaluator/Freshness.agda": {"best": 5.7, "last": 5.7, "runs": 3}, "cloud|agda-dev Rx/Evaluator/Freshness/Mono.agda": {"best": 12.5, "last": 12.5, "runs": 3}, "cloud|agda-dev Rx/Evaluator/Freshness/Preserve.agda": {"best": 13.6, "last": 19.6, "runs": 3}, "cloud|agda-dev Rx/Evaluator/Keeps-Slots.agda": {"best": 8.8, "last": 11.5, "runs": 4}, "cloud|agda-dev Rx/Evaluator/Reducible.agda": {"best": 6.2, "last": 13.1, "runs": 52}, "cloud|agda-dev Rx/Exp.agda": {"best": 7.0, "last": 16.8, "runs": 5}, "cloud|agda-dev Rx/Exp/Guarded.agda": {"best": 5.6, "last": 8.0, "runs": 2}, "cloud|agda-dev Rx/Inputs-Below.agda": {"best": 7.1, "last": 9.1, "runs": 4}, "cloud|agda-dev Rx/Mint.agda": {"best": 2.6, "last": 3.0, "runs": 4}, "cloud|agda-dev Rx/Prim.agda": {"best": 3.0, "last": 3.0, "runs": 3}, "cloud|agda-dev Rx/Protocol.agda": {"best": 3.0, "last": 3.0, "runs": 4}, "cloud|agda-dev Rx/Protocol/Sound.agda": {"best": 3.0, "last": 3.0, "runs": 3}, "cloud|agda-dev Rx/Provenance-Theorems.agda": {"best": 6.9, "last": 6.9, "runs": 1}, "cloud|agda-dev Rx/SExp.agda": {"best": 6.0, "last": 6.0, "runs": 1}, "cloud|agda-dev Rx/Slots.agda": {"best": 6.7, "last": 8.0, "runs": 2}, "cloud|agda-dev Rx/Subst-Compose.agda": {"best": 5.6, "last": 8.7, "runs": 4}, "cloud|agda-dev Rx/Subst-Elim-Weak.agda": {"best": 7.5, "last": 10.0, "runs": 7}, "cloud|agda-dev Rx/Subst-Elim.agda": {"best": 6.5, "last": 11.2, "runs": 3}, "cloud|agda-dev Rx/Subst-Eval.agda": {"best": 6.0, "last": 12.3, "runs": 5}, "cloud|agda-dev Rx/Subst-Identity.agda": {"best": 5.5, "last": 7.7, "runs": 6}, "cloud|agda-dev Rx/Subst-Ren-Fuse.agda": {"best": 7.8, "last": 9.4, "runs": 4}, "cloud|agda-dev Rx/Subst-Renaming.agda": {"best": 6.4, "last": 8.8, "runs": 4}, "cloud|agda-dev Rx/Subst-Split.agda": {"best": 6.1, "last": 6.1, "runs": 2}, "cloud|agda-dev Rx/Subst-Transport.agda": {"best": 5.6, "last": 8.2, "runs": 4}, "cloud|agda-dev Rx/Time-Theorems.agda": {"best": 7.2, "last": 7.2, "runs": 1}, "cloud|agda-dev Spec.agda": {"best": 3.5, "last": 3.5, "runs": 1}, "cloud|agda-dev Verify-Batch-Simultaneous/Batch-Theorems.agda": {"best": 5.0, "last": 5.0, "runs": 1}, "cloud|agda-dev Verify-Batch-Simultaneous/The-Proof.agda": {"best": 1.0, "last": 11.5, "runs": 90}, "cloud|agda-dev Verify-Determinacy.agda": {"best": 6.5, "last": 6.5, "runs": 1}, "cloud|agda-dev Verify-Run-Monotone.agda": {"best": 6.7, "last": 6.7, "runs": 1}, "cloud|agda-dev Verify-Well-Formed.agda": {"best": 6.4, "floor": true, "last": 1.0, "runs": 13}, "cloud|make gate-heavy (full gate, 13 modules)": {"best": 64.0, "last": 64.0, "runs": 1}, "cloud|make gate-heavy (full gate, 24 modules)": {"best": 2643.0, "last": 2643.0, "runs": 1}, "cloud|make gate-heavy (full gate, 326 modules)": {"best": 3374.0, "last": 3374.0, "runs": 1}, "cloud|make gate-heavy (full gate, 37 modules)": {"best": 2476.0, "last": 2476.0, "runs": 1}, "cloud|make gate-heavy (full gate, 51 modules)": {"best": 3917.0, "last": 3917.0, "runs": 1}, "local|agda-dev CLI/Decode.agda": {"best": 5.1, "last": 5.1, "runs": 1}, "local|agda-dev Decide.agda": {"best": 1.6, "last": 1.6, "runs": 1}, "local|agda-dev Main.agda": {"best": 45.0, "floor": true, "last": 45.0, "runs": 1}, "local|agda-dev QuickCheck.agda": {"best": 5.3, "last": 5.3, "runs": 2}, "local|agda-dev Readme-Theorems.agda": {"best": 4.1, "last": 4.1, "runs": 1}, "local|agda-dev Rx/Evaluator-Theorems.agda": {"best": 5.5, "last": 5.5, "runs": 1}, "local|agda-dev Rx/Evaluator.agda": {"best": 7.7, "last": 7.7, "runs": 2}, "local|agda-dev Rx/Exp.agda": {"best": 3.2, "last": 3.2, "runs": 3}, "local|agda-dev Rx/Slots.agda": {"best": 2.5, "last": 2.5, "runs": 3}, "local|agda-dev Verify-Batch-Simultaneous/The-Proof.agda": {"best": 7.0, "floor": true, "last": 2.0, "runs": 1023}, "local|make gate-heavy (full gate, 1 modules)": {"best": 5.0, "last": 7.0, "runs": 3}, "local|make gate-heavy (full gate, 10 modules)": {"best": 65.0, "last": 65.0, "runs": 5}, "local|make gate-heavy (full gate, 11 modules)": {"best": 18.0, "last": 1052.0, "runs": 9}, "local|make gate-heavy (full gate, 12 modules)": {"best": 375.0, "last": 1107.0, "runs": 5}, "local|make gate-heavy (full gate, 13 modules)": {"best": 88.0, "last": 1106.0, "runs": 5}, "local|make gate-heavy (full gate, 14 modules)": {"best": 19.0, "last": 1889.0, "runs": 2}, "local|make gate-heavy (full gate, 15 modules)": {"best": 19.0, "last": 80.0, "runs": 5}, "local|make gate-heavy (full gate, 16 modules)": {"best": 15.0, "last": 1101.0, "runs": 6}, "local|make gate-heavy (full gate, 17 modules)": {"best": 12.0, "last": 1495.0, "runs": 7}, "local|make gate-heavy (full gate, 174 modules)": {"best": 802.0, "last": 802.0, "runs": 1}, "local|make gate-heavy (full gate, 18 modules)": {"best": 28.0, "last": 278.0, "runs": 8}, "local|make gate-heavy (full gate, 19 modules)": {"best": 31.0, "last": 1203.0, "runs": 11}, "local|make gate-heavy (full gate, 2 modules)": {"best": 7.0, "last": 7.0, "runs": 1}, "local|make gate-heavy (full gate, 20 modules)": {"best": 32.0, "last": 32.0, "runs": 1}, "local|make gate-heavy (full gate, 21 modules)": {"best": 35.0, "last": 1697.0, "runs": 5}, "local|make gate-heavy (full gate, 22 modules)": {"best": 352.0, "last": 1312.0, "runs": 2}, "local|make gate-heavy (full gate, 23 modules)": {"best": 399.0, "last": 399.0, "runs": 1}, "local|make gate-heavy (full gate, 24 modules)": {"best": 1368.0, "last": 1368.0, "runs": 2}, "local|make gate-heavy (full gate, 25 modules)": {"best": 1211.0, "last": 1486.0, "runs": 3}, "local|make gate-heavy (full gate, 26 modules)": {"best": 1297.0, "last": 1297.0, "runs": 1}, "local|make gate-heavy (full gate, 28 modules)": {"best": 1448.0, "last": 1448.0, "runs": 1}, "local|make gate-heavy (full gate, 29 modules)": {"best": 1298.0, "last": 1298.0, "runs": 1}, "local|make gate-heavy (full gate, 3 modules)": {"best": 9.0, "last": 9.0, "runs": 1}, "local|make gate-heavy (full gate, 30 modules)": {"best": 1342.0, "last": 1342.0, "runs": 2}, "local|make gate-heavy (full gate, 306 modules)": {"best": 1709.0, "last": 1709.0, "runs": 2}, "local|make gate-heavy (full gate, 32 modules)": {"best": 1642.0, "last": 1642.0, "runs": 1}, "local|make gate-heavy (full gate, 34 modules)": {"best": 669.0, "last": 669.0, "runs": 1}, "local|make gate-heavy (full gate, 35 modules)": {"best": 1633.0, "last": 1633.0, "runs": 1}, "local|make gate-heavy (full gate, 36 modules)": {"best": 1338.0, "last": 1338.0, "runs": 1}, "local|make gate-heavy (full gate, 37 modules)": {"best": 1831.0, "last": 1831.0, "runs": 1}, "local|make gate-heavy (full gate, 38 modules)": {"best": 1477.0, "last": 1477.0, "runs": 1}, "local|make gate-heavy (full gate, 4 modules)": {"best": 9.0, "last": 11.0, "runs": 4}, "local|make gate-heavy (full gate, 43 modules)": {"best": 1791.0, "last": 1791.0, "runs": 1}, "local|make gate-heavy (full gate, 45 modules)": {"best": 662.0, "last": 662.0, "runs": 1}, "local|make gate-heavy (full gate, 46 modules)": {"best": 1407.0, "last": 1407.0, "runs": 1}, "local|make gate-heavy (full gate, 49 modules)": {"best": 743.0, "last": 743.0, "runs": 1}, "local|make gate-heavy (full gate, 5 modules)": {"best": 9.0, "last": 13.0, "runs": 6}, "local|make gate-heavy (full gate, 50 modules)": {"best": 660.0, "last": 1760.0, "runs": 4}, "local|make gate-heavy (full gate, 51 modules)": {"best": 1980.0, "last": 1980.0, "runs": 1}, "local|make gate-heavy (full gate, 52 modules)": {"best": 1893.0, "last": 1893.0, "runs": 1}, "local|make gate-heavy (full gate, 54 modules)": {"best": 1788.0, "last": 1788.0, "runs": 1}, "local|make gate-heavy (full gate, 55 modules)": {"best": 3004.0, "last": 3004.0, "runs": 1}, "local|make gate-heavy (full gate, 58 modules)": {"best": 2095.0, "last": 2095.0, "runs": 1}, "local|make gate-heavy (full gate, 59 modules)": {"best": 704.0, "last": 704.0, "runs": 1}, "local|make gate-heavy (full gate, 6 modules)": {"best": 10.0, "last": 34.0, "runs": 8}, "local|make gate-heavy (full gate, 61 modules)": {"best": 1592.0, "last": 1592.0, "runs": 1}, "local|make gate-heavy (full gate, 69 modules)": {"best": 1578.0, "last": 1578.0, "runs": 1}, "local|make gate-heavy (full gate, 7 modules)": {"best": 13.0, "last": 37.0, "runs": 11}, "local|make gate-heavy (full gate, 70 modules)": {"best": 1583.0, "last": 1583.0, "runs": 1}, "local|make gate-heavy (full gate, 77 modules)": {"best": 1658.0, "last": 1658.0, "runs": 1}, "local|make gate-heavy (full gate, 8 modules)": {"best": 38.0, "last": 38.0, "runs": 6}, "local|make gate-heavy (full gate, 85 modules)": {"best": 114.0, "last": 114.0, "runs": 1}, "local|make gate-heavy (full gate, 9 modules)": {"best": 14.0, "last": 38.0, "runs": 7}} -->
