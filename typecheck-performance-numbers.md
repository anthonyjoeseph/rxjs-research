...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **106.8 s** | 106.8 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk/Share-Fold.agda` | **40.0 s** | 127.0 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part2.agda` | **26.7 s** | 26.7 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part6.agda` | **21.3 s** | 21.3 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Depth.agda` | **20.4 s** | 20.4 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Cascade-Nodes.agda` | **19.8 s** | 19.8 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part3.agda` | **14.4 s** | 14.4 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 15.1 s | 4 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Chain-Caps-OK.agda` | **12.7 s** | 29.1 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Live-Nest-Walk.agda` | **11.9 s** | 11.9 s | 7 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part5.agda` | **11.7 s** | 11.7 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Nodes-Nest-Walk.agda` | **11.3 s** | 11.3 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Deliver-Measure.agda` | **11.1 s** | 11.1 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **10.4 s** | 597.6 s | 7 |
