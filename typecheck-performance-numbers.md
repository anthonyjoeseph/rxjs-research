...
| `agda-dev Implementation/Unit-Test/Bug-Cache.agda` | **8.0 s** | 8.9 s | 5 |
| `agda-dev Rx/Evaluator/Domain.agda` | **7.5 s** | 54.3 s | 10 |
| `agda-dev Rx/Plain.agda` | **7.4 s** | 7.4 s | 2 |
...
| `agda-dev Implementation/Unit-Test.agda` | **6.6 s** | 8.2 s | 8 |
| `agda-dev Implementation/Unit-Test/Prelude.agda` | **6.6 s** | 8.0 s | 6 |
...
| `agda-dev Rx/Simul-Slots.agda` | **6.0 s** | 6.0 s | 1 |
