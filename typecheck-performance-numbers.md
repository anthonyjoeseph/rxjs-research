...
| `agda-dev Rx/Evaluator/Builder.agda` | **14.6 s** | 14.6 s | 2 |
...
| `agda-dev Rx/Obs-Depth.agda` | **7.6 s** | 10.0 s | 3 |
...
| `agda-dev Rx/Evaluator/Doorless.agda` | **6.8 s** | 6.8 s | 2 |
