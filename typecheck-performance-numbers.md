...
| `make agda (full gate, 12 modules)` | **1277.0 s** | 1277.0 s | 1 |
...
| `agda-dev Verify-Well-Formed/Part3.agda` | **3.0 s** | 3.0 s | 5 |
| `agda-dev Verify-Budget-Sufficient/Depth-Compositional.agda` | **2.8 s** | 6.9 s | 8 |
| `agda-dev Rx/Flatten-Laws.agda` | **2.7 s** | 2.7 s | 1 |
