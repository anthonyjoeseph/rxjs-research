...
| `agda-dev Rx/Evaluator/Builder/Level.agda` | **6.8 s** | 7.3 s | 5 |
...
| `agda-dev Rx/Evaluator/Builder.agda` | **5.6 s** | 5.9 s | 19 |
| `agda-dev Rx/Evaluator/Reducible.agda` | **5.6 s** | 5.6 s | 64 |
