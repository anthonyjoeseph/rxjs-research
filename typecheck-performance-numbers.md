...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | 7.2 s | 10 |
| `make agda (full gate, 2 modules)` | **7.0 s** | 7.0 s | 1 |
| `agda-dev Verify-Well-Formed/Root-Probe.agda` | **6.5 s** | 7.7 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 14 |
...
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | 5.4 s | 7 |
