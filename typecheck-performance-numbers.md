...
| `agda-dev Rx/Subst-Split.agda` | **10.5 s** | 10.5 s | 1 |
...
| `agda-dev Verify-Well-Formed.agda` | **7.9 s** | >1 s | 3 |
...
| `agda-dev Rx/Evaluator/Reducible.agda` | **6.2 s** | >2 s | 41 |
| `agda-dev Rx/Subst-Eval.agda` | **6.0 s** | 6.0 s | 4 |
| `agda-dev ../evidence/refuted/Refuted/Main.agda` | **5.9 s** | 5.9 s | 7 |
| `agda-dev ../evidence/probed/Probed/Substitution-Leaves.agda` | **5.8 s** | 5.8 s | 6 |
| `agda-dev ../evidence/probed/Probed/Reducible-Arms.agda` | **5.6 s** | 7.7 s | 4 |
| `agda-dev Rx/Exp/Guarded.agda` | **5.6 s** | 5.6 s | 1 |
| `agda-dev Rx/Subst-Compose.agda` | **5.6 s** | 5.6 s | 2 |
