...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >45 s | 687 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >45 s | 224 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 361.0 s | 56 |
| `agda-dev ../evidence/refuted/Refuted/Chain-Level-Unbounded.agda` | **5.3 s** | 5.3 s | 1 |
| `agda-dev QuickCheck.agda` | **5.3 s** | 5.3 s | 2 |
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | >45 s | 131 |
