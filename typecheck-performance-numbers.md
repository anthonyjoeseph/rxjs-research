...
| `make gate-heavy (full gate, 7 modules)` | **13.0 s** | 26.0 s | 9 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 679 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 14.4 s | 51 |
