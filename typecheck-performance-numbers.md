...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **102.1 s** | >160 s | 19 |
...
| `agda-dev Verify-Budget-Sufficient/Subscribe-Face.agda` | **36.5 s** | 39.8 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part4.agda` | **22.1 s** | 24.6 s | 8 |
...
| `agda-dev Verify-Budget-Sufficient/Keeps-Ring.agda` | **16.5 s** | 16.5 s | 4 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Cascade-Caps.agda` | **10.7 s** | 14.0 s | 7 |
| `agda-dev ../evidence/refuted/Refuted/Frame-Step-Size-Store.agda` | **10.6 s** | 10.6 s | 1 |
| `agda-dev QuickCheck.agda` | **10.6 s** | 10.6 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part1.agda` | **10.6 s** | 10.6 s | 7 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Strat-Leaves.agda` | **8.6 s** | 9.6 s | 6 |
