...
| `make gate-heavy (full gate, 16 modules)` | **15.0 s** | 1385.0 s | 3 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 661 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 12.4 s | 45 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **3.1 s** | 42.0 s | 58 |
