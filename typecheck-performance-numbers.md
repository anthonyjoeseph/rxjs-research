...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 723 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 236 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 14.7 s | 61 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part1.agda` | **3.9 s** | 4.6 s | 8 |
