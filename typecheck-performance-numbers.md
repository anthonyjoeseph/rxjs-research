...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Connect.agda` | **25.9 s** | 26.2 s | 26 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **8.7 s** | 16.5 s | 32 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 416 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 164 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part3.agda` | **6.0 s** | 6.0 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Arms.agda` | **5.6 s** | 6.8 s | 30 |
...
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | >1 s | 108 |
