...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 24.1 s | 49 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Nest-Arith.agda` | **11.5 s** | 14.3 s | 15 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Factor.agda` | **8.0 s** | 27.5 s | 5 |
