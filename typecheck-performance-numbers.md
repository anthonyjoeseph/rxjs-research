...
| `agda-dev Verify-Budget-Sufficient/Subscribe-Face.agda` | **13.8 s** | 14.6 s | 5 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 458 |
| `make gate-heavy (full gate, 2 modules)` | **7.0 s** | 7.0 s | 1 |
| `agda-dev ../evidence/probed/Probed/Cascade-Mint-Base.agda` | **6.9 s** | 6.9 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part6.agda` | **6.6 s** | 6.6 s | 2 |
| `agda-dev Verify-Well-Formed/Root-Probe.agda` | **6.5 s** | 7.7 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | 1373.5 s | 186 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 17.9 s | 28 |
...
| `agda-dev ../evidence/probed/Probed/PushVals-Caps.agda` | **3.8 s** | 3.8 s | 1 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Subst.agda` | **3.5 s** | 4.2 s | 6 |
...
| `agda-dev Verify-Budget-Sufficient/Fan-Caps.agda` | **3.2 s** | 3.7 s | 2 |
| `agda-dev ../evidence/refuted/Refuted/Scan-Seed-Caps.agda` | **3.1 s** | 3.1 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Nest-Store.agda` | **3.1 s** | 3.5 s | 11 |
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **3.1 s** | 16.0 s | 25 |
...
| `agda-dev Rx/Clos-Size.agda` | **2.5 s** | 2.5 s | 2 |
