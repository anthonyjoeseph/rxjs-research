...
| `agda-dev Rx/Evaluator/Freshness/Preserve.agda` | **13.6 s** | 14.5 s | 4 |
| `agda-dev Rx/Evaluator/Builder.agda` | **13.2 s** | 13.7 s | 12 |
| `agda-dev Rx/Evaluator/Freshness/Mono.agda` | **12.5 s** | 13.9 s | 5 |
| `agda-dev QuickCheck.agda` | **10.6 s** | 22.9 s | 7 |
| `agda-dev Rx/Evaluator/Keeps-Slots.agda` | **8.8 s** | 9.2 s | 5 |
...
| `agda-dev Rx/Provenance-Theorems.agda` | **6.4 s** | 6.4 s | 2 |
| `agda-dev Verify-Well-Formed.agda` | **6.4 s** | 6.4 s | 14 |
...
| `agda-dev Rx/Envelope/Decode.agda` | **5.6 s** | 5.6 s | 1 |
