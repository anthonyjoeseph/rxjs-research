...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Walk-Sink.agda` | **34.3 s** | >160 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Arrival-Caps.agda` | **14.4 s** | >160 s | 5 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Store.agda` | **11.8 s** | 11.8 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Arrival-Ledger.agda` | **11.3 s** | >160 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Nodes-Nest-Walk.agda` | **11.3 s** | 13.8 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Chain-Caps-OK.agda` | **11.2 s** | >160 s | 5 |
