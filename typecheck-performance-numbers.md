...
| `agda-dev Rx/Evaluator/Freshness/Mono.agda` | **15.3 s** | 15.3 s | 2 |
...
| `agda-dev Verify-Input-Well-Formed/Run-Well-Formed.agda` | **7.3 s** | 7.3 s | 1 |
...
| `agda-dev Main.agda` | **6.8 s** | 13.6 s | 8 |
