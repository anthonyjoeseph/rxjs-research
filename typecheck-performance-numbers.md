...
| `agda-dev Main.agda` | **8.7 s** | 14.3 s | 6 |
...
| `agda-dev Verify-Take-Bounds.agda` | **6.8 s** | 6.8 s | 1 |
...
| `agda-dev ../evidence/probed/Probed/Take-Bounds.agda` | **6.7 s** | 6.7 s | 1 |
