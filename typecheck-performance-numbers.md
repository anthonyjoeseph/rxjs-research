...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 862 |
...
| `agda-dev Verify-Budget-Sufficient/Depth-Sighted.agda` | **3.7 s** | 10.1 s | 7 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **3.1 s** | >45 s | 70 |
