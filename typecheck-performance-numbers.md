...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **85.2 s** | 85.2 s | 2 |
| `make gate-heavy (full gate, 13 modules)` | **64.0 s** | 64.0 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Wet/Part2.agda` | **38.2 s** | 38.2 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Live-Nest-Walk.agda` | **16.6 s** | 16.6 s | 2 |
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **14.6 s** | 14.6 s | 3 |
