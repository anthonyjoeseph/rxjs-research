...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | 8.7 s | 697 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | 7.8 s | 228 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 14.1 s | 57 |
| `agda-dev ../evidence/refuted/Refuted/Chain-Level-Unbounded.agda` | **5.3 s** | 5.3 s | 1 |
| `agda-dev QuickCheck.agda` | **5.3 s** | 5.3 s | 2 |
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | 6.3 s | 135 |
