...
| `make gate-heavy (full gate, 24 modules)` | **1371.0 s** | 1371.0 s | 1 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 510 |
