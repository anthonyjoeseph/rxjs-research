...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **102.1 s** | >160 s | 17 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **47.4 s** | 59.3 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part6.agda` | **21.3 s** | 23.9 s | 4 |
