...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 47.3 s | 28 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Nest-Arith.agda` | **11.9 s** | 21.6 s | 10 |
| `agda-dev Verify-Budget-Sufficient/Live-Nest-Walk.agda` | **11.9 s** | 18.5 s | 10 |
...
| `agda-dev Verify-Budget-Sufficient/Nodes-Nest-Walk.agda` | **11.3 s** | 127.7 s | 4 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Chain-Caps-OK.agda` | **11.2 s** | 27.0 s | 7 |
...
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **10.4 s** | 13.1 s | 17 |
