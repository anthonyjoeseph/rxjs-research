...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Ring-Vocabulary.agda` | **11.6 s** | 11.6 s | 6 |
...
| `agda-dev Verify-Budget-Sufficient/Regs-Nest-Walk.agda` | **10.4 s** | 17.2 s | 36 |
