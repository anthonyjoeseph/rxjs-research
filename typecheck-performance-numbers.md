...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **102.1 s** | 120.1 s | 18 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Walk-Sink.agda` | **34.2 s** | 36.7 s | 10 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Arrival-Caps.agda` | **14.4 s** | 20.6 s | 11 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Depth-Fit.agda` | **13.6 s** | 24.9 s | 45 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7/Ring-Vocabulary.agda` | **11.7 s** | 12.5 s | 5 |
...
| `agda-dev Verify-Budget-Sufficient/Fold-Room.agda` | **9.5 s** | 13.1 s | 2 |
