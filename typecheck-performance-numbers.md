...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **8.7 s** | 8.7 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level.agda` | **5.5 s** | 43.0 s | 22 |
...
| `agda-dev Verify-Budget-Sufficient/Node-Fresh.agda` | **3.7 s** | 3.7 s | 1 |
