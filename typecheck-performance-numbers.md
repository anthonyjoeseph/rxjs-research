...
| `agda-dev ../evidence/probed/Probed/Main.agda` | **114.4 s** | 115.9 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Nodes-Nest-Walk.agda` | **10.9 s** | 10.9 s | 6 |
