...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **5.6 s** | 5.6 s | 1024 |
...
| `agda-dev Implementation/Unit-Test/Prelude.agda` | **3.3 s** | 3.3 s | 1 |
