...
| `make gate-heavy (full gate, 11 modules)` | **18.0 s** | 57.0 s | 8 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 663 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 13.2 s | 47 |
