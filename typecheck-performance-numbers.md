...
| `agda-dev Rx/Subst-Elim-Weak.agda` | **7.7 s** | 7.7 s | 4 |
...
| `agda-dev Rx/Evaluator/Reducible.agda` | **6.2 s** | >2 s | 48 |
| `agda-dev Rx/Subst-Split.agda` | **6.1 s** | 6.1 s | 2 |
| `agda-dev Rx/Evaluator/Freshness.agda` | **6.0 s** | 6.0 s | 2 |
