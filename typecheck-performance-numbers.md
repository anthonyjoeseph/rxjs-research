...
| `make agda (full gate, 19 modules)` | **31.0 s** | 31.0 s | 7 |
...
| `make agda (full gate, 9 modules)` | **15.0 s** | 15.0 s | 1 |
...
| `agda-dev Verify-Well-Formed/Part4.agda` | **7.3 s** | 7.3 s | 3 |
| `agda-dev Verify-Well-Formed/Part5.agda` | **7.3 s** | 7.3 s | 2 |
| `make agda (full gate, 2 modules)` | **7.0 s** | 7.0 s | 1 |
| `agda-dev Verify-Well-Formed/Root-Probe.agda` | **6.5 s** | 6.5 s | 2 |
