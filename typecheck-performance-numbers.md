...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 616 |
...
| `agda-dev Verify-Budget-Sufficient/Init-Nest.agda` | **4.0 s** | 39.2 s | 2 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **3.1 s** | 34.4 s | 55 |
