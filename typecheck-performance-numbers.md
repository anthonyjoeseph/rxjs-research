...
| `make gate-heavy (full gate, 10 modules)` | **1011.0 s** | 1253.0 s | 4 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Connect.agda` | **25.9 s** | >45 s | 29 |
...
| `agda-dev Verify-Budget-Sufficient/Caps.agda` | **14.1 s** | 14.9 s | 4 |
| `make gate-heavy (full gate, 9 modules)` | **14.0 s** | 58.0 s | 4 |
| `agda-dev Verify-Budget-Sufficient/Subscribe-Face.agda` | **13.8 s** | 14.8 s | 9 |
| `make gate-heavy (full gate, 7 modules)` | **13.0 s** | 48.0 s | 8 |
| `make gate-heavy (full gate, 17 modules)` | **12.0 s** | 1284.0 s | 5 |
...
| `make gate-heavy (full gate, 6 modules)` | **10.0 s** | 21.0 s | 6 |
| `agda-dev ../evidence/probed/Probed/Cascade-Nest-Flat.agda` | **9.7 s** | 9.7 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part2.agda` | **9.5 s** | 9.5 s | 2 |
...
| `make gate-heavy (full gate, 5 modules)` | **9.0 s** | 50.0 s | 4 |
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda` | **8.7 s** | >45 s | 35 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part4.agda` | **7.7 s** | 7.7 s | 5 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 675 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 221 |
...
| `agda-dev Verify-Budget-Sufficient/Walk-Level/Arms.agda` | **5.6 s** | >45 s | 33 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part3.agda` | **5.4 s** | 5.4 s | 4 |
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 13.3 s | 49 |
| `agda-dev ../evidence/refuted/Refuted/Chain-Level-Unbounded.agda` | **5.3 s** | 5.3 s | 1 |
| `agda-dev QuickCheck.agda` | **5.3 s** | 5.3 s | 2 |
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | >1 s | 130 |
...
| `agda-dev Verify-Budget-Sufficient/Psi-Split.agda` | **4.1 s** | 8.3 s | 8 |
...
| `agda-dev Verify-Budget-Sufficient/Init-Nest.agda` | **4.0 s** | 4.3 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part1.agda` | **3.9 s** | 11.6 s | 7 |
...
| `agda-dev Verify-Budget-Sufficient/Deliver-Measure.agda` | **3.7 s** | 3.9 s | 3 |
...
| `agda-dev Verify-Budget-Sufficient/Init-Caps.agda` | **3.5 s** | 3.5 s | 6 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Nest.agda` | **3.2 s** | 3.2 s | 3 |
| `agda-dev ../evidence/refuted/Refuted/Scan-Seed-Caps.agda` | **3.1 s** | 3.1 s | 1 |
| `agda-dev Verify-Budget-Sufficient/Nest-Store.agda` | **3.1 s** | 3.4 s | 13 |
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **3.1 s** | 35.9 s | 60 |
| `agda-dev Verify-Well-Formed/Part2.agda` | **3.1 s** | 3.1 s | 3 |
| `agda-dev Verify-Budget-Sufficient/Fan-Caps.agda` | **3.0 s** | 3.5 s | 4 |
| `agda-dev Verify-Budget-Sufficient/Nest-Cap.agda` | **3.0 s** | 3.2 s | 3 |
...
<!-- AUTO:DATA {"agda-dev ../evidence/probed/Probed/Burst-Nest-Level.agda": {"best": 4.0, "last": 4.0, "runs": 1}, "agda-dev ../evidence/probed/Probed/Cascade-Mint-Base.agda": {"best": 6.9, "last": 6.9, "runs": 1}, "agda-dev ../evidence/probed/Probed/Cascade-Nest-Flat.agda": {"best": 9.7, "last": 9.7, "runs": 1}, "agda-dev ../evidence/probed/Probed/Chain-Caps-Flat.agda": {"best": 45.0, "floor": true, "last": 45.0, "runs": 1}, "agda-dev ../evidence/probed/Probed/Chain-Walk-Level.agda": {"best": 7.2, "last": 7.2, "runs": 1}, "agda-dev ../evidence/probed/Probed/Depth-Nest-Flat.agda": {"best": 3.9, "last": 3.9, "runs": 1}, "agda-dev ../evidence/probed/Probed/PushVals-Caps.agda": {"best": 3.8, "last": 6.8, "runs": 4}, "agda-dev ../evidence/probed/Probed/Scan-Arr-Clos-Key.agda": {"best": 5.6, "last": 5.6, "runs": 1}, "agda-dev ../evidence/probed/Probed/Scan-Arr-Margin.agda": {"best": 3.6, "last": 8.6, "runs": 2}, "agda-dev ../evidence/probed/Probed/Scan-Burst-Nest.agda": {"best": 14.5, "floor": true, "last": 45.0, "runs": 3}, "agda-dev ../evidence/probed/Probed/Subscribe-Nest.agda": {"best": 3.4, "last": 3.4, "runs": 1}, "agda-dev ../evidence/probed/Probed/Sync-Factor.agda": {"best": 2.6, "last": 2.6, "runs": 1}, "agda-dev ../evidence/probed/Probed/Thru-Step-Indexed.agda": {"best": 10.4, "last": 10.4, "runs": 1}, "agda-dev ../evidence/refuted/Refuted/Chain-Level-Unbounded.agda": {"best": 5.3, "last": 5.3, "runs": 1}, "agda-dev ../evidence/refuted/Refuted/Inner-Drain-Nest.agda": {"best": 3.3, "last": 3.3, "runs": 3}, "agda-dev ../evidence/refuted/Refuted/Inner-Drain-Share-Nest.agda": {"best": 3.2, "last": 3.2, "runs": 1}, "agda-dev ../evidence/refuted/Refuted/Nest-Depth-Live-Reg.agda": {"best": 4.1, "last": 4.1, "runs": 1}, "agda-dev ../evidence/refuted/Refuted/Nest-Size-Currency.agda": {"best": 3.9, "last": 3.9, "runs": 1}, "agda-dev ../evidence/refuted/Refuted/PushVals-Queue-Width.agda": {"best": 3.6, "last": 3.6, "runs": 1}, "agda-dev ../evidence/refuted/Refuted/Scan-Seed-Caps.agda": {"best": 3.1, "last": 3.1, "runs": 1}, "agda-dev ../evidence/refuted/Refuted/Share-Go-Path.agda": {"best": 3.6, "last": 3.6, "runs": 1}, "agda-dev ../evidence/refuted/Refuted/Subscribe-Burst-Width.agda": {"best": 3.8, "last": 3.8, "runs": 2}, "agda-dev ../evidence/refuted/Refuted/Subscribe-Caps-Nest.agda": {"best": 3.4, "last": 3.4, "runs": 1}, "agda-dev ../evidence/refuted/Refuted/Thru-Scan-Burst-Nest.agda": {"best": 9.0, "last": 9.0, "runs": 1}, "agda-dev ../evidence/refuted/Refuted/Thru-Subscribe-Nest.agda": {"best": 3.4, "last": 3.4, "runs": 1}, "agda-dev ../evidence/refuted/Refuted/Walk-Frame-Drain-Level.agda": {"best": 5.5, "last": 5.5, "runs": 1}, "agda-dev CLI/Decode.agda": {"best": 5.1, "last": 5.1, "runs": 1}, "agda-dev Decide.agda": {"best": 1.6, "last": 1.6, "runs": 1}, "agda-dev Harness/Main.agda": {"best": 3.4, "last": 3.7, "runs": 18}, "agda-dev Main.agda": {"best": 45.0, "floor": true, "last": 45.0, "runs": 1}, "agda-dev QuickCheck.agda": {"best": 5.3, "last": 5.3, "runs": 2}, "agda-dev Readme-Theorems.agda": {"best": 4.1, "last": 4.1, "runs": 1}, "agda-dev Rx/Clos-Eta-Cong.agda": {"best": 2.7, "last": 2.7, "runs": 1}, "agda-dev Rx/Clos-Size.agda": {"best": 2.5, "last": 3.2, "runs": 3}, "agda-dev Rx/Evaluator-Theorems.agda": {"best": 5.5, "last": 5.5, "runs": 1}, "agda-dev Rx/Evaluator.agda": {"best": 10.9, "last": 10.9, "runs": 1}, "agda-dev Rx/Exp.agda": {"best": 3.2, "last": 3.2, "runs": 3}, "agda-dev Rx/Frame-Width.agda": {"best": 4.7, "last": 4.7, "runs": 2}, "agda-dev Rx/Hop-Depth.agda": {"best": 4.2, "last": 4.2, "runs": 1}, "agda-dev Rx/Hop-Eta-Cong.agda": {"best": 3.4, "last": 3.4, "runs": 1}, "agda-dev Rx/Hop-Spine.agda": {"best": 3.5, "last": 3.5, "runs": 1}, "agda-dev Rx/MergeAll-Laws.agda": {"best": 2.6, "last": 2.6, "runs": 4}, "agda-dev Rx/Nest-Depth.agda": {"best": 2.6, "last": 2.7, "runs": 3}, "agda-dev Rx/Slot-Clos.agda": {"best": 2.5, "last": 2.5, "runs": 2}, "agda-dev Rx/Slot-Hop.agda": {"best": 2.6, "last": 3.0, "runs": 4}, "agda-dev Rx/Slots.agda": {"best": 2.5, "last": 2.5, "runs": 3}, "agda-dev Verify-Batch-Simultaneous/The-Proof.agda": {"best": 7.0, "floor": true, "last": 2.0, "runs": 675}, "agda-dev Verify-Budget-Sufficient/Burst-Walk.agda": {"best": 9.2, "last": 10.8, "runs": 15}, "agda-dev Verify-Budget-Sufficient/Burst-Walk/Predicates.agda": {"best": 3.9, "last": 3.9, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Caps-Bridge-Bisect.agda": {"best": 2.8, "last": 1020.2, "runs": 14}, "agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda": {"best": 6.4, "floor": true, "last": 2.0, "runs": 221}, "agda-dev Verify-Budget-Sufficient/Caps-Chain.agda": {"best": 3.7, "last": 3.7, "runs": 6}, "agda-dev Verify-Budget-Sufficient/Caps-Depth.agda": {"best": 6.5, "last": 6.5, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Caps-Face.agda": {"best": 3.9, "last": 3.9, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Caps-Face/Part1.agda": {"best": 3.9, "last": 11.6, "runs": 7}, "agda-dev Verify-Budget-Sufficient/Caps-Face/Part2.agda": {"best": 9.5, "last": 9.5, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Caps-Face/Part3.agda": {"best": 5.4, "last": 5.4, "runs": 4}, "agda-dev Verify-Budget-Sufficient/Caps-Face/Part4.agda": {"best": 7.7, "last": 7.7, "runs": 5}, "agda-dev Verify-Budget-Sufficient/Caps-Face/Part5.agda": {"best": 4.0, "last": 5.1, "runs": 6}, "agda-dev Verify-Budget-Sufficient/Caps-Face/Part6.agda": {"best": 6.4, "last": 8.0, "runs": 4}, "agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda": {"best": 5.4, "last": 13.3, "runs": 49}, "agda-dev Verify-Budget-Sufficient/Caps-Nest.agda": {"best": 3.2, "last": 3.2, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Caps-Term.agda": {"best": 3.4, "last": 3.4, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Caps.agda": {"best": 14.1, "last": 14.9, "runs": 4}, "agda-dev Verify-Budget-Sufficient/Deliver-Measure.agda": {"best": 3.7, "last": 3.9, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Deliveries.agda": {"best": 3.7, "last": 3.7, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Delivery-Walk.agda": {"best": 8.1, "last": 8.1, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Demand-Probe-TEMP.agda": {"best": 3.7, "last": 5.4, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Demand-Probe.agda": {"best": 5.5, "last": 20.1, "runs": 4}, "agda-dev Verify-Budget-Sufficient/Demand-Programs.agda": {"best": 2.7, "last": 2.7, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Depth-Bound.agda": {"best": 3.5, "last": 3.5, "runs": 4}, "agda-dev Verify-Budget-Sufficient/Depth-Compositional.agda": {"best": 2.8, "last": 6.9, "runs": 8}, "agda-dev Verify-Budget-Sufficient/Fan-Caps.agda": {"best": 3.0, "last": 3.5, "runs": 4}, "agda-dev Verify-Budget-Sufficient/Hop-Burst-Face.agda": {"best": 3.4, "last": 228.6, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Hop-Spine-Face.agda": {"best": 3.6, "last": 3.6, "runs": 4}, "agda-dev Verify-Budget-Sufficient/Hop-Spine-Push.agda": {"best": 4.0, "last": 4.0, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Hop-Spine-Step.agda": {"best": 4.2, "last": 4.2, "runs": 6}, "agda-dev Verify-Budget-Sufficient/Hop-Spine-Sub.agda": {"best": 4.2, "last": 4.9, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Init-Caps.agda": {"best": 3.5, "last": 3.5, "runs": 6}, "agda-dev Verify-Budget-Sufficient/Init-Nest.agda": {"best": 4.0, "last": 4.3, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Keeps-Ring.agda": {"best": 8.1, "last": 8.1, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Level-Mono.agda": {"best": 3.5, "last": 3.5, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Measures.agda": {"best": 10.0, "last": 10.0, "runs": 9}, "agda-dev Verify-Budget-Sufficient/Nest-Burst.agda": {"best": 2.6, "last": 2.8, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Nest-Cap.agda": {"best": 3.0, "last": 3.2, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Nest-Ceiling.agda": {"best": 3.4, "last": 3.4, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Nest-Store.agda": {"best": 3.1, "last": 3.4, "runs": 13}, "agda-dev Verify-Budget-Sufficient/Nest-Sub.agda": {"best": 3.0, "last": 3.0, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Nest-Subst.agda": {"best": 3.5, "last": 3.9, "runs": 8}, "agda-dev Verify-Budget-Sufficient/Nest-Tower.agda": {"best": 3.6, "last": 4.2, "runs": 4}, "agda-dev Verify-Budget-Sufficient/Nest-Walk.agda": {"best": 3.1, "last": 35.9, "runs": 60}, "agda-dev Verify-Budget-Sufficient/Node-Fresh.agda": {"best": 3.7, "last": 6.6, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Node-Table.agda": {"best": 3.5, "last": 3.5, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Op-Budget.agda": {"best": 3.7, "last": 3.7, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Op-Dominance.agda": {"best": 3.3, "last": 3.3, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Psi-Split.agda": {"best": 4.1, "last": 8.3, "runs": 8}, "agda-dev Verify-Budget-Sufficient/Queue-Dead.agda": {"best": 2.8, "last": 6.7, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Scan-Node-Probe.agda": {"best": 3.4, "last": 3.4, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Subscribe-Face.agda": {"best": 13.8, "last": 14.8, "runs": 9}, "agda-dev Verify-Budget-Sufficient/Walk-Level.agda": {"best": 5.5, "floor": true, "last": 46.5, "runs": 29}, "agda-dev Verify-Budget-Sufficient/Walk-Level/Arms.agda": {"best": 5.6, "floor": true, "last": 45.0, "runs": 33}, "agda-dev Verify-Budget-Sufficient/Walk-Level/Connect.agda": {"best": 25.9, "floor": true, "last": 45.0, "runs": 29}, "agda-dev Verify-Budget-Sufficient/Walk-Level/Parts.agda": {"best": 8.7, "floor": true, "last": 45.0, "runs": 35}, "agda-dev Verify-Budget-Sufficient/Walk-Level/Statement.agda": {"best": 4.1, "last": 4.1, "runs": 8}, "agda-dev Verify-Budget-Sufficient/Wet.agda": {"best": 3.7, "last": 3.7, "runs": 1}, "agda-dev Verify-Budget-Sufficient/Wet/Part1.agda": {"best": 4.3, "last": 4.3, "runs": 5}, "agda-dev Verify-Budget-Sufficient/Wet/Part2.agda": {"best": 22.6, "last": 22.6, "runs": 3}, "agda-dev Verify-Budget-Sufficient/Wet/Part3.agda": {"best": 4.7, "last": 4.7, "runs": 2}, "agda-dev Verify-Budget-Sufficient/Wet/Part6.agda": {"best": 3.9, "last": 3.9, "runs": 6}, "agda-dev Verify-Well-Formed/Part1.agda": {"best": 3.4, "last": 3.4, "runs": 2}, "agda-dev Verify-Well-Formed/Part10.agda": {"best": 7.7, "last": 9.0, "runs": 3}, "agda-dev Verify-Well-Formed/Part11.agda": {"best": 7.4, "last": 7.4, "runs": 4}, "agda-dev Verify-Well-Formed/Part12.agda": {"best": 8.5, "last": 8.5, "runs": 2}, "agda-dev Verify-Well-Formed/Part13.agda": {"best": 5.3, "floor": true, "last": 1.0, "runs": 130}, "agda-dev Verify-Well-Formed/Part2.agda": {"best": 3.1, "last": 3.1, "runs": 3}, "agda-dev Verify-Well-Formed/Part3.agda": {"best": 3.0, "last": 3.1, "runs": 7}, "agda-dev Verify-Well-Formed/Part4.agda": {"best": 7.3, "last": 8.5, "runs": 4}, "agda-dev Verify-Well-Formed/Part5.agda": {"best": 7.3, "last": 7.3, "runs": 2}, "agda-dev Verify-Well-Formed/Part6.agda": {"best": 7.9, "last": 7.9, "runs": 1}, "agda-dev Verify-Well-Formed/Part7.agda": {"best": 7.5, "last": 7.5, "runs": 2}, "agda-dev Verify-Well-Formed/Part8.agda": {"best": 3.5, "last": 3.5, "runs": 5}, "agda-dev Verify-Well-Formed/Part9.agda": {"best": 8.7, "last": 8.7, "runs": 2}, "agda-dev Verify-Well-Formed/Root-Probe.agda": {"best": 6.5, "last": 7.7, "runs": 3}, "agda-dev Zz-Probe.agda": {"best": 1.4, "last": 2.8, "runs": 7}, "make gate-heavy (full gate, 1 modules)": {"best": 5.0, "last": 5.0, "runs": 2}, "make gate-heavy (full gate, 10 modules)": {"best": 1011.0, "last": 1253.0, "runs": 4}, "make gate-heavy (full gate, 11 modules)": {"best": 18.0, "last": 1052.0, "runs": 9}, "make gate-heavy (full gate, 12 modules)": {"best": 375.0, "last": 375.0, "runs": 4}, "make gate-heavy (full gate, 13 modules)": {"best": 1357.0, "last": 1357.0, "runs": 1}, "make gate-heavy (full gate, 14 modules)": {"best": 19.0, "last": 1889.0, "runs": 2}, "make gate-heavy (full gate, 15 modules)": {"best": 19.0, "last": 19.0, "runs": 3}, "make gate-heavy (full gate, 16 modules)": {"best": 15.0, "last": 1064.0, "runs": 4}, "make gate-heavy (full gate, 17 modules)": {"best": 12.0, "last": 1284.0, "runs": 5}, "make gate-heavy (full gate, 174 modules)": {"best": 802.0, "last": 802.0, "runs": 1}, "make gate-heavy (full gate, 18 modules)": {"best": 28.0, "last": 33.0, "runs": 6}, "make gate-heavy (full gate, 19 modules)": {"best": 31.0, "last": 1203.0, "runs": 11}, "make gate-heavy (full gate, 2 modules)": {"best": 7.0, "last": 7.0, "runs": 1}, "make gate-heavy (full gate, 20 modules)": {"best": 32.0, "last": 32.0, "runs": 1}, "make gate-heavy (full gate, 21 modules)": {"best": 35.0, "last": 1187.0, "runs": 4}, "make gate-heavy (full gate, 22 modules)": {"best": 352.0, "last": 1312.0, "runs": 2}, "make gate-heavy (full gate, 23 modules)": {"best": 399.0, "last": 399.0, "runs": 1}, "make gate-heavy (full gate, 24 modules)": {"best": 1368.0, "last": 1368.0, "runs": 2}, "make gate-heavy (full gate, 25 modules)": {"best": 1211.0, "last": 1211.0, "runs": 2}, "make gate-heavy (full gate, 26 modules)": {"best": 1297.0, "last": 1297.0, "runs": 1}, "make gate-heavy (full gate, 28 modules)": {"best": 1448.0, "last": 1448.0, "runs": 1}, "make gate-heavy (full gate, 29 modules)": {"best": 1298.0, "last": 1298.0, "runs": 1}, "make gate-heavy (full gate, 30 modules)": {"best": 1342.0, "last": 1342.0, "runs": 2}, "make gate-heavy (full gate, 306 modules)": {"best": 1709.0, "last": 1709.0, "runs": 2}, "make gate-heavy (full gate, 32 modules)": {"best": 1642.0, "last": 1642.0, "runs": 1}, "make gate-heavy (full gate, 34 modules)": {"best": 669.0, "last": 669.0, "runs": 1}, "make gate-heavy (full gate, 35 modules)": {"best": 1633.0, "last": 1633.0, "runs": 1}, "make gate-heavy (full gate, 36 modules)": {"best": 1338.0, "last": 1338.0, "runs": 1}, "make gate-heavy (full gate, 37 modules)": {"best": 1831.0, "last": 1831.0, "runs": 1}, "make gate-heavy (full gate, 4 modules)": {"best": 9.0, "last": 9.0, "runs": 3}, "make gate-heavy (full gate, 43 modules)": {"best": 1791.0, "last": 1791.0, "runs": 1}, "make gate-heavy (full gate, 45 modules)": {"best": 662.0, "last": 662.0, "runs": 1}, "make gate-heavy (full gate, 49 modules)": {"best": 743.0, "last": 743.0, "runs": 1}, "make gate-heavy (full gate, 5 modules)": {"best": 9.0, "last": 50.0, "runs": 4}, "make gate-heavy (full gate, 50 modules)": {"best": 660.0, "last": 1520.0, "runs": 3}, "make gate-heavy (full gate, 51 modules)": {"best": 1980.0, "last": 1980.0, "runs": 1}, "make gate-heavy (full gate, 52 modules)": {"best": 1893.0, "last": 1893.0, "runs": 1}, "make gate-heavy (full gate, 54 modules)": {"best": 1788.0, "last": 1788.0, "runs": 1}, "make gate-heavy (full gate, 58 modules)": {"best": 2095.0, "last": 2095.0, "runs": 1}, "make gate-heavy (full gate, 59 modules)": {"best": 704.0, "last": 704.0, "runs": 1}, "make gate-heavy (full gate, 6 modules)": {"best": 10.0, "last": 21.0, "runs": 6}, "make gate-heavy (full gate, 61 modules)": {"best": 1592.0, "last": 1592.0, "runs": 1}, "make gate-heavy (full gate, 69 modules)": {"best": 1578.0, "last": 1578.0, "runs": 1}, "make gate-heavy (full gate, 7 modules)": {"best": 13.0, "last": 48.0, "runs": 8}, "make gate-heavy (full gate, 70 modules)": {"best": 1583.0, "last": 1583.0, "runs": 1}, "make gate-heavy (full gate, 77 modules)": {"best": 1658.0, "last": 1658.0, "runs": 1}, "make gate-heavy (full gate, 8 modules)": {"best": 41.0, "last": 62.0, "runs": 4}, "make gate-heavy (full gate, 85 modules)": {"best": 114.0, "last": 114.0, "runs": 1}, "make gate-heavy (full gate, 9 modules)": {"best": 14.0, "last": 58.0, "runs": 4}} -->
