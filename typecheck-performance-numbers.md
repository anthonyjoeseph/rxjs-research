...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | 8.4 s | 1010 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | 8.0 s | 288 |
...
| `agda-dev Verify-Well-Formed/Part13.agda` | **5.3 s** | 6.2 s | 161 |
