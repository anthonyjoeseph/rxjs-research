...
| `agda-dev ../evidence/probed/Probed/Sight-Fit-Width.agda` | **14.4 s** | 14.4 s | 1 |
...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 930 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 275 |
...
| `agda-dev Verify-Budget-Sufficient/Depth-Sighted.agda` | **3.7 s** | 10.3 s | 9 |
...
| `agda-dev Verify-Budget-Sufficient/Sighted-Fit.agda` | **3.7 s** | 3.7 s | 1 |
