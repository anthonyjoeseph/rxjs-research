...
| `agda-dev Verify-Batch-Simultaneous/The-Proof.agda` | **7.0 s** | >2 s | 737 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Bridge.agda` | **6.4 s** | >2 s | 242 |
...
| `agda-dev Verify-Budget-Sufficient/Caps-Face/Part7.agda` | **5.4 s** | 15.1 s | 65 |
...
| `agda-dev Verify-Budget-Sufficient/Nest-Walk.agda` | **3.1 s** | >45 s | 61 |
