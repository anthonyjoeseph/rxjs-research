...
- **The spec must move** — including the case where the documented semantics and the
  spec genuinely disagree, which is a question and never a patch.
...
Ten traps inside the language, each of which cost real time at least once, and they
