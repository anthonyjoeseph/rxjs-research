...
-- AND THE COUNT OF DOUBLINGS A BOUND ACTUALLY COSTS, WHICH IS ITS BIT
-- LENGTH AND NOT THE BOUND.  The sibling above says `n` doublings
-- overshoot `n` outright; that is true and it is an exponential
