...
-- the proof of the very conjuncts they were about; the probes keep their
-- own headers in .Demand-Probe.
--
...
-- the curve is in series Q's header, .Demand-Probe.  Spell it
